...
DB::table('subscriptionheader')->updateOrInsert(
    ...
    ['Tanggal' => date('Y-m-d'), 'NamaSubscription' => 'Premium Bengkel', 'JenisUsaha' => 'Bengkel', 'AllowMonitorAntrean' => 1, 'AllowPesananMeja' => 1, 'AllowAccounting' => 1, 'AllowPaymentGateway' => 1]
);
