...
use App\Http\Controllers\GateSerialNumberController;
// Gate Serial Number
Route::get('/gate-serialnumber', [GateSerialNumberController::class, 'View'])->name('gate-serialnumber')->middleware(['auth', 'check.session']);
Route::get('/gate-serialnumber/form/{id}', [GateSerialNumberController::class, 'Form'])->name('gate-serialnumber-form')->middleware(['auth', 'check.session']);
Route::post('/gate-serialnumber/store', [GateSerialNumberController::class, 'store'])->name('gate-serialnumber-store')->middleware(['auth', 'check.session']);
Route::post('/gate-serialnumber/edit', [GateSerialNumberController::class, 'edit'])->name('gate-serialnumber-edit')->middleware(['auth', 'check.session']);
Route::post('/gate-serialnumber/delete/{id}', [GateSerialNumberController::class, 'deletedata'])->name('gate-serialnumber-delete')->middleware(['auth', 'check.session']);
Route::post('/gate-serialnumber/generate', [GateSerialNumberController::class, 'generateJson'])->name('gate-serialnumber-generate')->middleware(['auth', 'check.session']);
...
// Centralized SuperAdmin Subscription Ledger and Prospect Dashboard
Route::get('/dstechgloballedger', [\App\Http\Controllers\DstechGlobalSyncController::class, 'viewGlobalDashboard'])->name('dstechgloballedger')->middleware(['auth', 'check.session']);
Route::post('/dstechgloballedger/data', [\App\Http\Controllers\DstechGlobalSyncController::class, 'getGlobalLedgerData'])->name('dstechgloballedger-data')->middleware(['auth', 'check.session']);
Route::post('/dstechgloballedger/broadcast', [\App\Http\Controllers\DstechGlobalSyncController::class, 'sendBulkProspectBroadcast'])->name('dstechgloballedger-broadcast')->middleware(['auth', 'check.session']);
...
Route::get('/queue/{id}', [QueueManagementController::class,'index'])->name('queue-management');
Route::post('/queue/getData', [QueueManagementController::class, 'handleQueue'])->name('queue-getData');
Route::get('/queue-bengkel/{id}', [QueueBengkelController::class,'index'])->name('queue-bengkel');
Route::post('/queue-bengkel/getData', [QueueBengkelController::class, 'getData'])->name('queue-bengkel-getData');
Route::post('/queue-bengkel/updateStatus', [QueueBengkelController::class, 'updateStatus'])->name('queue-bengkel-updateStatus');
...
use App\Http\Controllers\InfoPeracikanController;
use App\Http\Controllers\QueueApotekController;

/*
|--------------------------------------------------------------------------
| Antrean & Monitor Apotek
|--------------------------------------------------------------------------
|
*/
Route::get('/infoperacikan', [InfoPeracikanController::class, 'InfoPeracikan'])->name('infoperacikan')->middleware(['auth', 'check.session']);
Route::post('/infoperacikan/data', [InfoPeracikanController::class, 'InfoPeracikanData'])->name('infoperacikan-data')->middleware(['auth', 'check.session']);
Route::post('/infoperacikan/markdone', [InfoPeracikanController::class, 'InfoPeracikanMarkDone'])->name('infoperacikan-markdone')->middleware(['auth', 'check.session']);
Route::post('/infoperacikan/updatestatus', [InfoPeracikanController::class, 'InfoPeracikanUpdateStatus'])->name('infoperacikan-updatestatus')->middleware(['auth', 'check.session']);
Route::get('/infokitchen-print', [App\Http\Controllers\FakturPenjualanController::class, 'InfoKitchenPrint'])->name('infokitchen-print')->middleware(['auth', 'check.session']);
Route::post('/recall-order', [App\Http\Controllers\FakturPenjualanController::class, 'RecallOrder'])->name('recall-order')->middleware(['auth', 'check.session']);

Route::get('/queue-apotek', [QueueApotekController::class, 'index'])->name('queue-apotek')->middleware(['auth', 'check.session']);
Route::get('/queue-apotek/{id}', [QueueApotekController::class, 'index'])->name('queue-apotek-id');
Route::post('/queue-apotek/getData', [QueueApotekController::class, 'handleQueue'])->name('queue-apotek-getData');
