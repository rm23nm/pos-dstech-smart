...
class CompanyController extends Controller
{
    ...
    public function View(Request $request)
    {
        ...
        // Optimize: Increased timeout for heavy company data (base64 images)
        set_time_limit(180);
        ...
        $userdata = UserRole::leftJoin('users', function ($value){
            ...
            if ($model) {
             ...
             //    $model->Nama = $request->input('Nama');
                ...
                \App\Services\DBLogger::update('company', ['KodePartner' => Auth::user()->RecordOwnerID], [
                    ...
                    'icon' => empty(trim($request->input('image_base64') ?? '')) ? "" : trim($request->input('image_base64')),
                    ...
                    'Banner1' => empty(trim($request->input('Banner1Base64') ?? '')) ? "" : trim($request->input('Banner1Base64')),
                    'Banner2' => empty(trim($request->input('Banner2Base64') ?? '')) ? "" : trim($request->input('Banner2Base64')),
                    'Banner3' => empty(trim($request->input('Banner3Base64') ?? '')) ? "" : trim($request->input('Banner3Base64')),
                    ...
                    'ShowLinkInReciept' => 0,
                    'ImageCustDisplay1' => empty(trim($request->input('ImageCustDisplay1Base64') ?? '')) ? "" : trim($request->input('ImageCustDisplay1Base64')),
                    'ImageCustDisplay2' => empty(trim($request->input('ImageCustDisplay2Base64') ?? '')) ? "" : trim($request->input('ImageCustDisplay2Base64')),
                    'ImageCustDisplay3' => empty(trim($request->input('ImageCustDisplay3Base64') ?? '')) ? "" : trim($request->input('ImageCustDisplay3Base64')),
                    'ImageCustDisplay4' => empty(trim($request->input('ImageCustDisplay4Base64') ?? '')) ? "" : trim($request->input('ImageCustDisplay4Base64')),
                    'ImageCustDisplay5' => empty(trim($request->input('ImageCustDisplay5Base64') ?? '')) ? "" : trim($request->input('ImageCustDisplay5Base64')),
                    ...
                    'BannerBooking' => empty(trim($request->input('BannerBookingBase64') ?? '')) ? "" : trim($request->input('BannerBookingBase64')),
                    ...
                    'ImageGallery1' => empty(trim($request->input('ImageGallery1Base64') ?? '')) ? "" : trim($request->input('ImageGallery1Base64')),
                    'ImageGallery2' => empty(trim($request->input('ImageGallery2Base64') ?? '')) ? "" : trim($request->input('ImageGallery2Base64')),
                    'ImageGallery3' => empty(trim($request->input('ImageGallery3Base64') ?? '')) ? "" : trim($request->input('ImageGallery3Base64')),
                    'ImageGallery4' => empty(trim($request->input('ImageGallery4Base64') ?? '')) ? "" : trim($request->input('ImageGallery4Base64')),
                    'ImageGallery5' => empty(trim($request->input('ImageGallery5Base64') ?? '')) ? "" : trim($request->input('ImageGallery5Base64')),
                    'ImageGallery6' => empty(trim($request->input('ImageGallery6Base64') ?? '')) ? "" : trim($request->input('ImageGallery6Base64')),
                    'ImageGallery7' => empty(trim($request->input('ImageGallery7Base64') ?? '')) ? "" : trim($request->input('ImageGallery7Base64')),
                    'ImageGallery8' => empty(trim($request->input('ImageGallery8Base64') ?? '')) ? "" : trim($request->input('ImageGallery8Base64')),
                    'ImageGallery9' => empty(trim($request->input('ImageGallery9Base64') ?? '')) ? "" : trim($request->input('ImageGallery9Base64')),
                    'ImageGallery10' => empty(trim($request->input('ImageGallery10Base64') ?? '')) ? "" : trim($request->input('ImageGallery10Base64')),
                    'ImageGallery11' => empty(trim($request->input('ImageGallery11Base64') ?? '')) ? "" : trim($request->input('ImageGallery11Base64')),
                    'ImageGallery12' => empty(trim($request->input('ImageGallery12Base64') ?? '')) ? "" : trim($request->input('ImageGallery12Base64')),
                    ...
                    'VideoKlinikDisplay' => empty($request->input('VideoKlinikDisplay')) ? "" : $request->input('VideoKlinikDisplay'),
                    'VideoKlinikDisplay2' => empty($request->input('VideoKlinikDisplay2')) ? "" : $request->input('VideoKlinikDisplay2'),
                    'VideoKlinikDisplay3' => empty($request->input('VideoKlinikDisplay3')) ? "" : $request->input('VideoKlinikDisplay3'),
                    'VideoKlinikDisplay4' => empty($request->input('VideoKlinikDisplay4')) ? "" : $request->input('VideoKlinikDisplay4'),
                    'VideoKlinikDisplay5' => empty($request->input('VideoKlinikDisplay5')) ? "" : $request->input('VideoKlinikDisplay5'),
                    ...
                    'Backgraund' => empty(trim($request->input('BackgraundBase64') ?? '')) ? $request->input('Backgraund') : trim($request->input('BackgraundBase64')),
                    'TypeKitchenBackgraund' => $request->input('TypeKitchenBackgraund'),
                    'KitchenBackgraund' => empty(trim($request->input('KitchenBackgraundBase64') ?? '')) ? $request->input('KitchenBackgraund') : trim($request->input('KitchenBackgraundBase64')),
                    'KioskBackground' => empty(trim($request->input('KioskBackgroundBase64') ?? '')) ? $request->input('KioskBackground') : trim($request->input('KioskBackgroundBase64')),
