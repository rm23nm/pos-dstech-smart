				...
				<div class="row">
                    ...
                    @php
                        $premiumCategories = [
                            ...
                            'bengkel' => ['PermissionName' => 'Manajemen Bengkel & Dealer', 'Icon' => 'fas fa-wrench', 'submenu' => [], 'ParentType' => 1],
                            ...
                            if (!empty($lv1['submenu'])) {
                                foreach ($lv1['submenu'] as $lv2) {
                                    ...
                                    if ($l2Name === 'bussiness partner') {
                                        ...
                                        $targetCat = 'resto';
                                    } elseif (in_array($l2Name, ['produk', 'term and conditon', 'app setting', 'pengguna', 'invoice pengguna', 'article', 'serial number generator', 'voucher', 'integrasi multi-app'])) {
                                        $targetCat = 'system';
                                    } elseif (in_array($l2Name, ['antrian bengkel', 'riwayat servis', 'pendaftaran servis', 'mekanik progres', 'data booking bengkel'])) {
                                        $targetCat = 'bengkel';
                                    } elseif (in_array($l2Name, ['closing kasir', 'closing bulanan'])) {
                                        $targetCat = 'finance';
