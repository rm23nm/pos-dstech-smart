...
<head>
	...
	<style type="text/css">
		...
		/* One Page Layout - Fit 100vh perfectly, no page-level vertical scrollbar */
		.contentPOS {
		...
		.contentPOS > .container-fluid,
		.contentPOS > .container-fluid > .row {
			height: 100% !important;
			max-height: 100% !important;
			margin: 0 !important;
		}
		.contentPOS > .container-fluid > .row > div {
			height: 100% !important;
			max-height: 100% !important;
   ...
   <header class="pos-header bg-white">
	...
	<form id="PoSSubmit">
		<div class="contentPOS">
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-12 d-flex flex-column" style="height: 100% !important; max-height: 100% !important;">
						<div class="card card-custom bg-white border-0 flex-grow-1 d-flex flex-column mb-0" style="height: 100% !important; min-height: 0 !important;">
							<div class="card-body d-flex flex-column p-3" style="height: 100% !important; overflow: hidden !important;">
								...
								<hr class="my-2">
								<div class="product-items flex-grow-1" style="overflow-y: auto; height: 0 !important; min-height: 0 !important; padding-right: 4px;">
					...
					<div class="col-xl-3 col-lg-3 col-md-12 d-flex flex-column" style="height: 100% !important; max-height: 100% !important; gap: 8px;">
						<!-- Barcode Scanner Card -->
						<div class="card card-custom bg-white border-0 mb-0">
							<div class="card-body p-2">
								...
								<div id="_activeInputIndicator" class="mt-1 text-center font-weight-bold" style="font-size: 0.8rem; letter-spacing: 0.5px; color: #dc2626;">
						...
						<!-- Touch NumPad Card -->
						<div class="card card-custom bg-white border-0 mb-0 flex-grow-1" style="min-height: 0 !important;">
							<div class="card-body p-2 d-flex flex-column justify-content-between" style="height: 100% !important; min-height: 0 !important;">
					...
					<div class="col-xl-3 col-lg-3 col-md-12 d-flex flex-column" style="height: 100% !important; max-height: 100% !important;">
						<div class="receipt-tape flex-grow-1 d-flex flex-column justify-content-between" style="height: 100% !important; min-height: 0 !important; padding: 1rem !important; margin-bottom: 0 !important;">
							<div class="d-flex flex-column flex-grow-1" style="height: 0 !important; min-height: 0 !important;">
								<div class="d-flex justify-content-between align-items-center mb-2">
									<h5 class="font-weight-extrabold mb-0" style="color: var(--primary); letter-spacing: 0.5px; font-size: 0.95rem;"><i class="fas fa-receipt me-2"></i>STRUK BELANJA</h5>
									<span class="badge bg-success text-white font-weight-bold px-2 py-1" style="font-size: 0.65rem;">LIVE TAPE</span>
								</div>
								
								<!-- Digital Cart Items Table -->
								<div class="table-responsive flex-grow-1 scrollbar-1 mb-2" style="overflow-y: auto; height: 0 !important; min-height: 0 !important; border: 1.5px solid #cbd5e1; border-radius: 16px; background: rgba(0,0,0,0.01);">
