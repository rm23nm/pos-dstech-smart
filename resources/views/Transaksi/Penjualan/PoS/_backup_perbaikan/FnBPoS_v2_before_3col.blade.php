														...
														<tbody>
															...
															<tr class="d-flex align-items-center justify-content-between">
																...
																<td class="border-0 justify-content-end d-flex align-items-center text-dark font-size-base">
																	<div class="input-group" style="width: 180px; height: 35px;">
																		<input type="text" name="_VoucherCode" id="_VoucherCode" placeholder="KODE" class="form-control text-uppercase" style="font-size: 0.85rem !important; height: 35px !important; padding: 2px 8px !important; border: 1.5px solid rgba(11, 87, 208, 0.3) !important; border-radius: 8px 0 0 8px !important; font-weight: 700 !important; background: rgba(11, 87, 208, 0.02) !important;">
																		<button class="btn btn-primary d-flex align-items-center justify-content-center px-3" type="button" id="btnApplyVoucher" style="height: 35px !important; border-radius: 0 8px 8px 0 !important; background: var(--primary) !important; font-size: 0.8rem; font-weight: 800; border: none; padding: 0 15px !important;">
																			Cek
																		</button>
																	</div>
																</td>
															</tr>
															<tr class="d-flex align-items-center justify-content-between" id="rowVoucherDiscount">
																<th class="border-0 ">
																	<div class="d-flex align-items-center font-size-h5 mb-0 font-size-bold text-danger">
																		Voucher Discount
																	</div>
																</th>
																<td class="border-0 justify-content-end d-flex text-danger font-size-base">
																	<input type="text" name="_VoucherDiscount" id="_VoucherDiscount" value="0" class="form-control TotalText text-danger font-weight-bold" style="color: #dc2626 !important;" readonly>
																</td>
															</tr>
															<tr class="d-flex align-items-center justify-content-between">
																<th class="border-0 font-size-h5 mb-0 font-size-bold text-dark">
