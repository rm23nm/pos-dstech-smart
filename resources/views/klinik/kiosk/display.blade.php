...
<body>
    ...
    <div class="header-tv">
        <div class="brand">
            ...
            <div class="brand-info">
                <h1>{{ $company->NamaPerusahaan ?? 'KLINIK SMART' }}</h1>
                <p>{{ $company->Alamat ?? 'Layanan Pendaftaran Antrean' }}</p>
            </div>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="bottom-grid">
            @if(isset($lokets) && count($lokets) > 0)
                @foreach($lokets as $loket)
                <div class="loket-box loket-dinamis">
                    <div class="loket-header">{{ strtoupper($loket->NamaLoket) }}</div>
                    <div class="loket-body">
                        <div class="loket-number loket-number-dinamis" id="loket-{{ $loket->id }}">--</div>
                    </div>
                </div>
                @endforeach
            @else
    ...
    <div class="footer-tv">
        <div class="marquee">
            {{ $company->RunningText ?? 'SELAMAT DATANG DI KLINIK KAMI. JAM BUKA LAYANAN KAMI ADALAH PUKUL 07:00 S/D 21:00. TERIMA KASIH ATAS KUNJUNGAN ANDA, KAMI SENANTIASA MELAYANI SEPENUH HATI.' }}
        </div>
    </div>
