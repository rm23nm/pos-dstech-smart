								...
								<div class="form-group row">
                                    ...
                                    @php
                                        ...
                                        $classifyLevel2 = function($item) {
                                            ...
                                            // Display / KDS
                                            $displayIds = [113, 115, 116, 117, 118, 119];
	...
	$(function () {
		...
		$(document).ready(function () {
            ...
            function filterMenuByUsaha() {
                ...
                jQuery('.group-card-retail, .group-card-fnb, .group-card-hiburan, .group-card-display').hide();
                // Umum & Keuangan always show
                jQuery('.group-card-keuangan, .group-card-umum').show(); 

                if (jenis == 'Retail') {
                    // Retail: tampilkan fitur retail + Customer Display POS
                    jQuery('.group-card-retail, .group-card-display').fadeIn();
                } else if (jenis == 'FnB') {
                    // FnB: fitur restoran + semua layar display
                    jQuery('.group-card-fnb, .group-card-display').fadeIn();
                } else if (jenis == 'Hiburan') {
                    // Hiburan: fitur hiburan + semua layar display (sama seperti FnB)
                    jQuery('.group-card-hiburan, .group-card-display').fadeIn();
                } else {
                    // Show all if empty
                    jQuery('.group-card-retail, .group-card-fnb, .group-card-hiburan, .group-card-display').show();
                }
            }
