            ...
            <form id="formKendaraan">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label>Service Advisor / PIC Utama</label>
                            <select name="KodeAdvisor" id="KodeAdvisor" class="form-control">
                            ...
                            <small class="text-muted">Jika diisi, booking online untuk kendaraan ini akan otomatis diteruskan ke advisor tersebut.</small>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#formKendaraan').on('submit', function(e) {
            ...
            let url = isEdit ? "{{ url('kendaraan/update') }}/" + jQuery('#KodeKendaraan').val() : "{{ route('kendaraan.store') }}";
    ...
    function editData(rowBase64) {
        ...
        jQuery('#KodeAdvisor').val(row.KodeAdvisor);
