									...
									@if(strtolower($lv1['PermissionName']) == 'master' && (count($cData) > 0 && $cData[0]->AllowMonitorAntrean == 1))
										...
										<li class="nav-item {{ $isDisplaiActive ? 'active' : '' }}">
											<a class="nav-link {{ $isDisplaiActive ? '' : 'collapsed' }}" data-bs-toggle="collapse"  href="javascript:void(0)" data-bs-target="#DisplaiMenu" role="button" aria-expanded="{{ $isDisplaiActive ? 'true' : 'false' }}" aria-controls="DisplaiMenu">
												...
												<span class="nav-text">Displai</span>
												<i class="fas fa-chevron-right fa-rotate-90"></i>
											</a>
										</li>

										<div class="collapse nav-collapse {{ $isDisplaiActive ? 'show' : '' }}" id="DisplaiMenu" data-bs-parent="#accordion">
											<div id="accordionDisplai">
												<ul class="nav flex-column">
													<!-- Info Kitchen -->
													<li class="nav-item {{ request()->routeIs('infokitchen') ? 'active' : '' }}">
														<a href="{{ route('infokitchen') }}" target="_blank" class="nav-link sub-nav-link">
															<span class="svg-icon nav-icon d-flex justify-content-center">
																<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																	<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																</svg>
															</span>
															<span class="nav-text">Info Kitchen</span>
														</a>
													</li>
													<!-- Queue Antrian FNB (Monitor TV) -->
													<li class="nav-item {{ request()->routeIs('customerdisplay') ? 'active' : '' }}">
														<a href="{{ route('customerdisplay') }}" target="_blank" class="nav-link sub-nav-link">
															<span class="svg-icon nav-icon d-flex justify-content-center">
																<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																	<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																</svg>
													...
													<li class="nav-item {{ request()->routeIs('infokitchen') ? 'active' : '' }}">
														<a href="{{ route('infokitchen') }}" target="_blank" class="nav-link sub-nav-link">
															...
															<span class="nav-text">Antrian FNB Dapur</span>
														</a>
													</li>
													<!-- Queue Lapangan -->
													<li class="nav-item {{ request()->is('queue/*') ? 'active' : '' }}">
														<a href="{{ url('/queue/' . base64_encode(Auth::user()->RecordOwnerID)) }}" target="_blank" class="nav-link sub-nav-link">
															<span class="svg-icon nav-icon d-flex justify-content-center">
																<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																	<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																</svg>
															</span>
															<span class="nav-text">Queue Lapangan</span>
														</a>
													</li>
													<!-- Custumer Display POS -->
													<li class="nav-item {{ request()->routeIs('fpenjualan-custdisplay') ? 'active' : '' }}">
														<a href="{{ route('fpenjualan-custdisplay') }}" target="_blank" class="nav-link sub-nav-link">
															<span class="svg-icon nav-icon d-flex justify-content-center">
																<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																	<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																</svg>
															</span>
															<span class="nav-text">Custumer Display POS</span>
														</a>
													</li>
												</ul>
											</div>
