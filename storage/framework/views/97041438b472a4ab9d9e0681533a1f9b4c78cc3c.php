...
<html lang="en">
	<head>
		...
		<link href="<?php echo e(asset('api/multiple-select/multiple-select.min.css')); ?>" rel="stylesheet">
	...
	<div id="tc_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="<?php echo e(route('dashboard')); ?>" class="brand-logo">
			...
			<span class="brand-text"><img style="height: 100%;" alt="Logo" src="<?php echo e(asset('images/misc/logo-dashboard.png')); ?>" /></span>
		...
		<div class="d-flex flex-row flex-column-fluid page">
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="tc_aside">
				...
				<div class="brand flex-column-auto" id="tc_brand">
					<!--begin::Logo-->
					<a href="<?php echo e(route('dashboard')); ?>" class="brand-logo">
						<img class="brand-image" style="height: 100%;" alt="Logo" src="<?php echo e(asset('images/misc/logo-dashboard.png')); ?>" />
						<span class="brand-text"><img style="height: 100%;" alt="Logo"
								src="<?php echo e(asset('images/misc/logo-dashboard.png')); ?>" /></span>
					...
					<div id="tc_aside_menu" class="aside-menu  mb-5" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<div id="accordion">
							<ul class="nav flex-column">
								<?php if(!isset($cData[0]['JenisUsaha']) || $cData[0]['JenisUsaha'] != 'Parkir'): ?>
								...
								<li class="nav-item <?php echo e(request()->routeIs('log') ? 'active' : ''); ?>">
									<a href="<?php echo e(route('log', ['id' => base64_encode(Auth::user()->RecordOwnerID)])); ?>" class="nav-link">
										<span class="svg-icon nav-icon">
									...
									<?php if($hasActiveCats): ?>
										...
										<?php $__currentLoopData = $sec['keys']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if(isset($activePremiumCategories[$cKey])): ?>
												...
												?>
												<li class="nav-item <?php echo e($lv1ExactActive ? 'active' : ''); ?>">
													<a class="nav-link <?php echo e(($lv1ExactActive || $lv1ChildActive) ? '' : 'collapsed'); ?>" data-bs-toggle="collapse" href="javascript:void(0)" data-bs-target="#<?php echo e($cKey); ?>" role="button" aria-expanded="<?php echo e(($lv1ExactActive || $lv1ChildActive) ? 'true' : 'false'); ?>" aria-controls="<?php echo e($cKey); ?>">
														<span class="svg-icon nav-icon">
															<i class="<?php echo e($lv1['Icon']); ?> font-size-h4"></i>
														</span>
														<span class="nav-text"><?php echo e($lv1['PermissionName']); ?></span>
														<i class="fas fa-chevron-right fa-rotate-90"></i>
													</a>
												</li>

												<div class="collapse nav-collapse <?php echo e(($lv1ExactActive || $lv1ChildActive) ? 'show' : ''); ?>" id="<?php echo e($cKey); ?>" data-bs-parent="#accordion">
													<div id="accordion_<?php echo e($cKey); ?>">
														<ul class="nav flex-column">
															<?php if(count($lv1['submenu']) > 0): ?>
																<?php $__currentLoopData = $lv1['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<?php if(isset($lv2['ParentType']) && $lv2['ParentType'] == 1): ?>
																		<?php 
																			$lv2ExactActive = is_nav_exact_active($lv2);
																			$lv2ChildActive = is_nav_child_active($lv2);
																		?>
																		<li class="nav-item <?php echo e($lv2ExactActive ? 'active' : ''); ?>">
																			<a class="nav-link sub-nav-link <?php echo e(($lv2ExactActive || $lv2ChildActive) ? '' : 'collapsed'); ?>" data-bs-toggle="collapse" href="#sub_<?php echo e(str_replace([' ', '.'],'',$lv2['PermissionName'])); ?>" role="button" aria-expanded="<?php echo e(($lv2ExactActive || $lv2ChildActive) ? 'true' : 'false'); ?>" aria-controls="sub_<?php echo e(str_replace([' ', '.'],'',$lv2['PermissionName'])); ?>">
																				<span class="svg-icon nav-icon d-flex justify-content-center">
																					<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																						<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																					</svg>
																				</span>
																				<span class="nav-text"><?php echo e($lv2['PermissionName']); ?></span>
																				<i class="fas fa-chevron-right fa-rotate-90"></i>
																			</a>

																			<div class="collapse nav-collapse <?php echo e(($lv2ExactActive || $lv2ChildActive) ? 'show' : ''); ?>" id="sub_<?php echo e(str_replace([' ', '.'],'',$lv2['PermissionName'])); ?>" data-bs-parent="#accordion_<?php echo e($cKey); ?>">
																				<ul class="nav flex-column">
																					<?php if(count($lv2['submenu']) > 0): ?>
																						<?php $__currentLoopData = $lv2['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																							<li class="nav-item <?php echo e(is_nav_exact_active($lv3) ? 'active' : ''); ?>">
																								<a href="<?php echo e(Route::has($lv3['Link']) ? route($lv3['Link']) : url($lv3['Link'])); ?>" class="nav-link mini-sub-nav-link">
																									<span class="nav-text"><?php echo e($lv3['PermissionName']); ?></span>
																								</a>
																							</li>
																	...
																	<?php else: ?>
																		<li class="nav-item <?php echo e(is_nav_exact_active($lv2) ? 'active' : ''); ?>">
																			<a href="<?php echo e(url($lv2['Link'])); ?>" class="nav-link sub-nav-link">
																				<span class="svg-icon nav-icon d-flex justify-content-center">
																					<svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" fill="currentColor" class="bi bi-circle" viewBox="0 0 16 16">
																						<path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
																					</svg>
				...
				<div class="container-fluid d-flex align-items-stretch justify-content-between">
											...
											<div class="topbar-item">
												<div class="btn btn-icon w-auto btn-clean d-flex align-items-center pr-1 ps-3">
													<span class="symbol symbol-35 symbol-light-success">
															<?php if(!empty($cData[0]['icon'])): ?>
																<img src="<?php echo e($cData[0]['icon']); ?>" width="20px" height="20px">
															<?php else: ?>
																<i class="bi bi-shop text-white" style="font-size: 1.2rem;"></i>
															<?php endif; ?>
													</span>
													<label></label>
													<a href="<?php echo e(url('companysetting')); ?>" class="text-dark-50 font-size-base d-none d-xl-inline me-3"> <?php echo e($cData[0]['NamaPartner']); ?></a>
												</div>
											</div>
					...
					<div class="topbar">	
						...
						<div class="posicon d-lg-flex d-none">
							<?php if(isset($cData[0]['JenisUsaha']) && $cData[0]['JenisUsaha'] === 'TiketGate'): ?>
								<a href="<?php echo e(url('gate/logs')); ?>" class="btn btn-info white me-2">Log Gate</a>
								<a href="<?php echo e(url('fpenjualan/pos')); ?>" class="btn btn-primary white me-2">POS Tiket</a>
							<?php elseif(isset($cData[0]['JenisUsaha']) && in_array($cData[0]['JenisUsaha'], ['Bengkel', 'Servis'])): ?>
								<a href="<?php echo e(url('fpenjualan/bengkelpos')); ?>" class="btn btn-primary white me-2">
									<i class="fas fa-cash-register mr-1"></i> POS Kasir
								</a>
							<?php else: ?>
								<a href="<?php echo e(url('fpenjualan/pos')); ?>" class="btn btn-primary white me-2">
									<i class="fas fa-cash-register mr-1"></i> POS Kasir
								</a>
							<?php endif; ?>
						</div>
						...
						<div class="dropdown">
							...
							<div class="topbar-item" data-bs-toggle="dropdown" data-display="static">
								<div class="btn btn-icon w-auto btn-clean d-flex align-items-center pr-1 ps-3">
									<span class="text-dark-50 font-size-base d-none d-xl-inline me-3"><?php echo e(Auth::user()->name); ?></span>
									<span class="symbol symbol-35 symbol-light-success">
			...
			<div class="footer bg-white py-4 d-flex flex-lg-column" id="tc_footer">
				...
				<div
					...
					<div class="nav nav-dark">
						...
						<a href="<?php echo e(route('faqUser')); ?>" class="nav-link pl-0 pr-0">Support & FaQ</a>
					</div>
...
<!--end::Main-->
	...
	<script src="<?php echo e(asset('devexpress/jspdf.umd.min.js')); ?>"></script>
	<script src="<?php echo e(asset('devexpress/jspdf.plugin.autotable.min.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('api/apexcharts/apexcharts.js')); ?>"></script>
	<script src="<?php echo e(asset('api/pace/pace.js')); ?>"></script>
	<script src="<?php echo e(asset('api/mcustomscrollbar/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
	<script src="<?php echo e(asset('api/quill/quill.min.js')); ?>"></script>
	<script src="<?php echo e(asset('api/editor/classic.ckeditor.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('api/multiple-select/multiple-select.min.js')); ?>"></script>
	<script>window.define = tempDefine;</script>
	<script src="<?php echo e(asset('js/script.bundle.js')); ?>"></script>
	<script src="<?php echo e(asset('js/script-slick.js')); ?>"></script>
    ...
    <?php if(!request()->is('*pos*') && !request()->is('*display*') && !request()->is('*kds*') && !request()->is('*antrean*')): ?>
    <style>
        .chatbot-btn-backend {
            position: fixed;
            bottom: 30px;
...
</html><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/parts/header.blade.php ENDPATH**/ ?>