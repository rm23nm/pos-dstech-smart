								...
								<fieldset class="form-group mb-0 d-flex align-items-center gap-1">
									<div style="flex: 1; min-width: 0;">
										<select class="js-example-basic-single js-states form-control bg-transparent" id="KodeMekanik" name="KodeMekanik" style="width: 100%;">
											...
											<?php $__currentLoopData = $mekanik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($m->KodeMekanik); ?>">
													<?php echo e($m->NamaMekanik); ?>
...
<script type="text/javascript">
	...
	function openAdvisorPopup() {
		$('#advisorIframe').attr('src', "<?php echo e(route('service-advisor')); ?>?popup=1");
	...
	function SaveData(Status, ButonObject, ButtonDefaultText) {
		...
		$.ajax({
			async:false,
			url: (NoTransaksi) == "" ? "<?php echo e(route('fpenjualan-retailPos')); ?>" : "<?php echo e(route('fpenjualan-editJson')); ?>",
			type: 'POST',
	...
	function loadPKBSelesai() {
		$.ajax({
			url: "<?php echo e(url('fpenjualan/tarik-pkb')); ?>",
			type: "GET",
	...
	function prosesTarikPKB(noPkb) {
		$.ajax({
			url: "<?php echo e(url('fpenjualan/tarik-pkb/store')); ?>/" + noPkb,
			type: "POST",
			data: {
				_token: "<?php echo e(csrf_token()); ?>",
			},
...
<!--end::Body-->
</html><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/BengkelPoS.blade.php ENDPATH**/ ?>