...
<body>
  ...
  <header>
    <div class="header-left">
        <?php if(!empty($company->icon)): ?>
            <img src="<?php echo e($company->icon); ?>" alt="Logo" class="company-logo">
        <?php else: ?>
            <img src="https://via.placeholder.com/50" alt="Logo" class="company-logo">
        <?php endif; ?>
        <div id="company-name">
           <?php echo e($company->NamaPartner ?? 'Company Name'); ?>
  ...
  <div class="running-text-strip">
     <div class="blinking-text">
        <marquee><?php echo e($company->RunningTextSelfServices ?? 'Selamat Datang'); ?></marquee>
     </div>
  </div>
  ...
  <div class="main-grid">
    ...
    <div class="grid-box area-promo slider-area" id="slides">
      <?php if(isset($oImageData) && count($oImageData) > 0): ?>
        <?php $__currentLoopData = $oImageData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($image['type'] === 'image'): ?>
            <div class="image-banner<?php echo e($loop->first ? ' active' : ''); ?>">
              <img src="<?php echo e($image['url']); ?>" alt="Promo">
            </div>
          <?php endif; ?>
           <?php if($image['type'] === 'video'): ?>
            <div class="video-banner<?php echo e($loop->first ? ' active' : ''); ?>">
              <iframe id="ytplayer-<?php echo e($loop->index); ?>" class="youtube-frame"
                src="<?php echo e($image['url']); ?>?enablejsapi=1&mute=1"
  ...
  <script>
    ...
    function fetchQueueData(){
      ...
      $.ajax({
        url:"<?php echo e(route('queue-getData')); ?>",
        method:"POST",
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/QueueManagement/QueueManagement_v3.blade.php ENDPATH**/ ?>