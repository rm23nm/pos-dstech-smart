...
<body>
      ...
      <div class="d-flex align-items-center gap-2">
          ...
          <select id="tableFilter" class="form-select" style="width: 200px;">
              ...
              <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($table->id); ?>"><?php echo e($table->NamaTitikLampu); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
      </div>
      <div class="d-flex align-items-center gap-2">
  ...
  <script>
    ...
    function fetchKitchenData() {
        $.ajax({
            url: "<?php echo e(route('infokitchen-data')); ?>",
            method: "POST",
            data: {
    ...
    function updateOrderStatus(noTrx, status) {
        $.ajax({
            url: "<?php echo e(route('infokitchen-updatestatus')); ?>",
            method: "POST",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                NoTransaksi: noTrx,
    ...
    function markItemDone(noTrx, lineNo) {
        ...
        $.ajax({
            url: "<?php echo e(route('infokitchen-markdone')); ?>",
            method: "POST",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                RecordOwnerID: "<?php echo e(Auth::user()->RecordOwnerID); ?>",
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/InfoKitchen.blade.php ENDPATH**/ ?>