...
<head>
    <meta charset="utf-8" />
    <title>Customer Display | <?php echo e($company->NamaPartner); ?></title>
...
<body>
    <div class="display-wrapper">
        ...
        <div class="promo-side">
            <div class="slider-container" id="sliderContainer">
                <?php $__currentLoopData = $oImageData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slide" data-type="<?php echo e($item['type']); ?>" data-index="<?php echo e($index); ?>">
                        <?php if($item['type'] == 'image'): ?>
                            <img src="<?php echo e($item['url']); ?>" alt="Promotion <?php echo e($index + 1); ?>">
                        <?php else: ?>
                            <div id="yt-player-<?php echo e($index); ?>" class="yt-player-container"></div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>

            <?php if(!empty($company->RunningText) && $company->RunningText != "0"): ?>
                <div class="marquee-overlay">
                    <div class="marquee-text"><?php echo e($company->RunningText); ?></div>
                </div>
            <?php endif; ?>
        </div>
            ...
            <div class="billing-header">
                <div class="logo">
                    <?php if(!empty($company->icon)): ?>
                        <img src="<?php echo e($company->icon); ?>" alt="Logo">
                    <?php endif; ?>
                </div>
                <h2><?php echo e($company->NamaPartner); ?></h2>
            </div>
    ...
    <script>
        let mediaData = <?php echo json_encode($oImageData, 15, 512) ?>;
        let players = {};
        let currentIndex = 0;
        let slideInterval;
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/CustDisplay_new.blade.php ENDPATH**/ ?>