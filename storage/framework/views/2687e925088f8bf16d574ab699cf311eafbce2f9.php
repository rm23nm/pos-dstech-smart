                ...
                <div class="login-form-container">
                    ...
                    <form method="post" action="<?php echo e(route('action-login')); ?>">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo e(route('daftar')); ?>" class="btn btn-register mb-3">DAFTAR AKUN BARU</a>
                        </div>
                        
                        <div class="row g-2 mt-2">
                            <div class="col-6">
                                <a href="<?php echo e(url('downloads/Setup_DSMS_POS.exe')); ?>" class="btn btn-outline-primary w-100" style="font-size: 0.8rem; padding: 10px; border-radius: 8px;">
