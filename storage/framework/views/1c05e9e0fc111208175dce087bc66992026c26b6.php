			...
			<div class="col-12 px-4">
				...
				<div class="card card-custom gutter-b bg-white border-0">
					<div class="card-header border-0 px-4 pt-4 d-flex justify-content-between align-items-center">
						<h3 class="card-title mb-0 font-weight-bold text-body">Daftar Hari Libur Tahun <?php echo e($tahun); ?></h3>
						<div>
					...
					<div class="card-body px-4">
						<form method="GET" action="<?php echo e(route('hari-libur')); ?>" class="form-inline mb-4">
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped text-center">
								...
								<tbody>
									<?php if(count($libur) > 0): ?>
										<?php $__currentLoopData = $libur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											<td><?php echo e($index + 1); ?></td>
											<td class="font-weight-bold text-danger"><?php echo e(\Carbon\Carbon::parse($item->Tanggal)->translatedFormat('d F Y')); ?></td>
											<td><?php echo e($item->Keterangan); ?></td>
											<td>
												<button class="btn btn-sm btn-danger btn-hapus" data-id="<?php echo e($item->id); ?>">
...
$(document).ready(function() {
	$('#formAddLibur').submit(function(e) {
		...
		$.ajax({
			url: "<?php echo e(route('hari-libur-store')); ?>",
			type: "POST",
			data: $(this).serialize(),
	...
	$('.btn-hapus').click(function() {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: "<?php echo e(route('hari-libur-destroy')); ?>",
					type: "POST",
					data: {
...
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/hrd/HariLibur.blade.php ENDPATH**/ ?>