...
<head>
    ...
    <!-- Midtrans Snap -->
    <?php if(isset($midtransclientkey) && $midtransclientkey != ""): ?>
        <?php if(env('MIDTRANS_IS_PRODUCTION', false)): ?>
            <script src="https://app.midtrans.com/snap/snap.js" data-client-key="<?php echo e($midtransclientkey); ?>"></script>
        <?php else: ?>
            <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="<?php echo e($midtransclientkey); ?>"></script>
        <?php endif; ?>
    <?php endif; ?>
...
<body>
    <header class="pos-header">
        <div class="brand">
            <?php if(count($company) > 0 && !empty($company[0]->icon)): ?>
                <img src="<?php echo e($company[0]->icon); ?>" alt="Logo" style="height: 40px; border-radius: 6px; background: white; padding: 2px; vertical-align: middle;">
            <?php endif; ?>
            <span style="margin-left: 12px;"><?php echo e($company[0]->NamaPartner ?? 'DSTech'); ?> Self-Service</span>
        </div>
            ...
            <?php $__currentLoopData = $kelompoklampu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($itemInGroup->count() > 0): ?>
                    <div class="kelompok-section">
                        <div class="kelompok-title"><?php echo e($tl->NamaKelompok); ?></div>
                        <div class="titik-grid">
                            <?php $__currentLoopData = $itemInGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="titik-box <?php echo e($statusClass); ?>"
                                     ...
                                     data-jammulai="<?php echo e($item->JamMulaiParsed ?? '-'); ?>"
                                     data-jamselesai="<?php echo e($item->JamSelesaiParsed ?? '-'); ?>"
                                     ...
                                     data-kodekelompok="<?php echo e($item->KelompokLampu); ?>"
                                     data-statuslabel="<?php echo e($item->StatusMeja); ?>"
                                     data-totalPembayaran="<?php echo e($item->TotalPembayaran ?? 0); ?>"
                                     onclick="selectTitikLampu(this)">
                                    <?php echo e($item->DigitalInput); ?>
            ...
            <div class="pp-body">
                <form id="frmPilihPaket" autocomplete="off">
                        ...
                        <div class="pp-field">
                            ...
                            <select class="pp-input" id="ppJenisPaket" onchange="onJenisPaketChange(this.value)">
                                ...
                                <?php $__currentLoopData = $jenisLangganan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(is_array($jl) ? $jl['Kode'] : $jl); ?>"><?php echo e(is_array($jl) ? $jl['Nama'] : $jl); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="pp-field">
                        ...
                        <div class="pp-field">
                            ...
                            <select class="pp-input" id="ppKodePelanggan" onchange="calculateTotal()">
                                ...
                                <?php $__currentLoopData = $pelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->KodePelanggan); ?>"><?php echo e($p->NamaPelanggan); ?> (<?php echo e($p->KodePelanggan); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="fnb-selection-area">
                        ...
                        <div class="fnb-list" id="ppFnbList">
                            <?php $__currentLoopData = $itemmaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="fnb-item" data-name="<?php echo e(strtolower($item->NamaItem)); ?>" style="<?php echo e($isHabis ? 'opacity:0.5; filter:grayscale(0.8);' : ''); ?>">
                                    ...
                                    <div class="fnb-item-info">
                                        ...
                                        <div class="fnb-item-price">
                                            Rp <?php echo e(number_format($item->HargaJual)); ?> 
                                            <span style="margin-left:8px; color:<?php echo e($isHabis ? '#d32f2f' : '#888'); ?>; font-weight:<?php echo e($isHabis ? '700' : '400'); ?>;">
                                                Stok: <?php echo e(number_format($item->Stock ?? 0)); ?>

                                                <?php if($isHabis): ?> (HABIS) <?php endif; ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="fnb-qty-ctrl">
                                        <button type="button" class="fnb-qty-btn" onclick="<?php echo e($isHabis ? "swal('Stok Habis','Item tidak tersedia','warning')" : "updateFnbQty('{$item->KodeItem}', -1, '{$item->NamaItem}', {$item->HargaJual}, 'ppFnbList')"); ?>">-</button>
                                        <div class="fnb-qty-val" id="qty-<?php echo e($item->KodeItem); ?>-ppFnbList">0</div>
                                        <button type="button" class="fnb-qty-btn" onclick="<?php echo e($isHabis ? "swal('Stok Habis','Item tidak tersedia','warning')" : "updateFnbQty('{$item->KodeItem}', 1, '{$item->NamaItem}', {$item->HargaJual}, 'ppFnbList')"); ?>">+</button>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="pp-row" style="display:none;">
                        <input type="hidden" id="ppKodeSales" value="<?php echo e(Auth::user()->KodeSales ?? ''); ?>">
                    </div>
                        ...
                        <div class="pp-row mt-2" style="margin-top:15px;">
                            ...
                            <select class="pp-input" id="ppMetodePembayaran" onchange="calculateTotal()">
                                <?php $__currentLoopData = $metodepembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(in_array($mp->TipePembayaran, ['QRIS', 'MIDTRANS']) || str_contains(strtoupper($mp->NamaMetodePembayaran), 'QRIS')): ?>
                                        <option value="<?php echo e($mp->id); ?>" data-tipe="<?php echo e($mp->TipePembayaran); ?>" data-percent="<?php echo e($mp->BiayaAdminPercent ?? 0); ?>" data-rupiah="<?php echo e($mp->BiayaAdminRupiah ?? 0); ?>"><?php echo e($mp->NamaMetodePembayaran); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="fnb-list" id="fnbOnlyList" style="max-height: 400px;">
                        <?php $__currentLoopData = $itemmaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="fnb-item" data-name="<?php echo e(strtolower($item->NamaItem)); ?>" style="<?php echo e($isHabis ? 'opacity:0.5; filter:grayscale(0.8);' : ''); ?>">
                                ...
                                <div class="fnb-qty-ctrl">
                                    <button type="button" class="fnb-qty-btn" onclick="<?php echo e($isHabis ? "swal('Stok Habis','Item tidak tersedia','warning')" : "updateFnbQty('{$item->KodeItem}', -1, '{$item->NamaItem}', {$item->HargaJual}, 'fnbOnlyList')"); ?>">-</button>
                                    <div class="fnb-qty-val" id="qty-<?php echo e($item->KodeItem); ?>-fnbOnlyList">0</div>
                                    <button type="button" class="fnb-qty-btn" onclick="<?php echo e($isHabis ? "swal('Stok Habis','Item tidak tersedia','warning')" : "updateFnbQty('{$item->KodeItem}', 1, '{$item->NamaItem}', {$item->HargaJual}, 'fnbOnlyList')"); ?>">+</button>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div id="fnbOnlySummary" style="background:#f0f4f8; padding:20px; border-radius:12px; margin-top:20px;">
                    ...
                    <div class="pp-row mt-3" style="margin-top:15px;">
                        ...
                        <select class="pp-input" id="fnbOnlyMetode">
                            <?php $__currentLoopData = $metodepembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(in_array($mp->TipePembayaran, ['QRIS', 'MIDTRANS']) || str_contains(strtoupper($mp->NamaMetodePembayaran), 'QRIS')): ?>
                                    <option value="<?php echo e($mp->id); ?>" data-tipe="<?php echo e($mp->TipePembayaran); ?>"><?php echo e($mp->NamaMetodePembayaran); ?></option>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div id="mdPaymentSection" style="display:none; margin-top:20px; background:#fff3e0; padding:15px; border-radius:10px; border:1px solid #ffe0b2;">
                    ...
                    <div class="pp-row" style="margin-top:10px;">
                        ...
                        <select class="pp-input" id="mdMetodePembayaran" onchange="onDetailMetodeChange()">
                            <?php $__currentLoopData = $metodepembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(in_array($mp->TipePembayaran, ['QRIS', 'MIDTRANS']) || str_contains(strtoupper($mp->NamaMetodePembayaran), 'QRIS')): ?>
                                    <option value="<?php echo e($mp->id); ?>" data-tipe="<?php echo e($mp->TipePembayaran); ?>" data-percent="<?php echo e($mp->BiayaAdminPercent); ?>" data-rupiah="<?php echo e($mp->BiayaAdminRupiah); ?>"><?php echo e($mp->NamaMetodePembayaran); ?></option>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div class="pp-row">
                    ...
                    <select class="pp-input" id="tjPaketId" onchange="calculateTambahJam()">
                        <?php $__currentLoopData = $paket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($p->JenisPaket == 'JAM'): ?>
                                <option value="<?php echo e($p->id); ?>" data-harga="<?php echo e($p->HargaNormal); ?>" data-durasi="<?php echo e($p->DurasiPaket ?? 1); ?>"><?php echo e($p->NamaPaket); ?></option>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                    ...
                    <div style="flex:1; overflow-y:auto; border:1px solid #eee; border-radius:12px; margin-top:10px; background:#fafafa;">
                         <div style="padding:15px; display:grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap:15px;" id="jfQuickGrid">
                            <?php $__currentLoopData = $itemmaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $isHabis = ($item->Stock ?? 0) <= 0; ?>
                                <div class="fnb-card" 
                                     onclick="<?php echo e($isHabis ? "swal('Stok Habis', 'Maaf, menu ini sedang tidak tersedia.', 'warning')" : 'addJfToCart(' . json_encode($item) . ')'); ?>" 
                                     style="background:#fff; border:1px solid #eee; border-radius:12px; padding:10px; cursor:pointer; transition:all 0.2s; display:flex; flex-direction:column; align-items:center; text-align:center; box-shadow:0 2px 5px rgba(0,0,0,0.05); position:relative; <?php echo e($isHabis ? 'opacity:0.6; filter:grayscale(0.8);' : ''); ?>">
                                    ...
                                    <div style="font-weight:700; font-size:0.85rem; color:#333; height:34px; overflow:hidden; line-height:1.2;"><?php echo e($item->NamaItem); ?></div>
                                    <div style="font-weight:800; color:#e65100; margin-top:5px; font-size:0.9rem;">Rp <?php echo e(number_format($item->HargaJual)); ?></div>
                                    <div style="font-size:0.7rem; color:<?php echo e($isHabis ? '#d32f2f' : '#888'); ?>; margin-top:2px; font-weight:<?php echo e($isHabis ? '700' : '400'); ?>;">
                                        Stok: <?php echo e(number_format($item->Stock ?? 0)); ?>
    ...
    var dataPelangganAll = <?php echo json_encode($pelanggan); ?>;
    var dataGrupPelanggan = <?php echo json_encode($gruppelanggan); ?>;
    ...
    function refreshTableStatuses() {
        ...
        fetch('<?php echo e(route("billing-get-table-statuses")); ?>')
            .then(res => res.json())
    ...
    function fetchSlots() {
        ...
        fetch('<?php echo e(route("billing-getAvailableSlots")); ?>', {
            method: 'POST',
    ...
    function submitFnbOnly() {
        ...
        .then((r) => {
            if (r.value) {
                ...
                fetch('<?php echo e(route("billing-store-fnb-order")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
    ...
    function onKonfirmasiPaket() {
        ...
        .then((r) => {
            if (r.value) {
                ...
                fetch('<?php echo e(route("billing-store-paket")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    body: JSON.stringify(payload)
                }).then(res => res.json()).then(res => {
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/BillingSelfService.blade.php ENDPATH**/ ?>