						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
							    ...
							    <div class="icons d-flex">
									<a href="<?php echo e($BookingURLString); ?>" class="btn btn-outline-primary rounded-pill font-weight-bold me-1 mb-1" target="_blank">Buka Website Booking Online</a>
...
<script type="text/javascript">
    ...
    function GetHeader() {
        $.ajax({
            async:false,
            type: 'post',
            url: "<?php echo e(route('booking-getBookingsList')); ?>",
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/ListBookingOnlineV2.blade.php ENDPATH**/ ?>