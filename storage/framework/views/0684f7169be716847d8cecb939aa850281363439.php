...
<script type="text/javascript">
	...
	function renderCatalog(products) {
		...
		products.forEach(function(item) {
			...
			var imgUrl = item.Gambar ? (item.Gambar.startsWith('http://') || item.Gambar.startsWith('https://') || item.Gambar.startsWith('data:') ? item.Gambar : (item.Gambar.startsWith('/') ? `<?php echo e(url('')); ?>${item.Gambar}` : `<?php echo e(asset('images')); ?>/${item.Gambar}`)) : `https://placehold.co/150x100/e2e8f0/475569?text=${encodeURIComponent(item.NamaItem)}`;
...
</script><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/ApotekPoS.blade.php ENDPATH**/ ?>