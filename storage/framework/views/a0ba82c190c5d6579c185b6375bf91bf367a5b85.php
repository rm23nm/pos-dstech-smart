...
<head>
    ...
    <style>
        body {
            <?php if(isset($company) && $company->KioskBackground): ?>
            background-image: url('<?php echo e(asset($company->KioskBackground)); ?>');
...
<body>
    ...
    <div class="kiosk-container">
        <?php if(isset($company) && $company->Logo): ?>
            <img src="<?php echo e(asset($company->Logo)); ?>" alt="Logo" class="company-logo">
        <?php endif; ?>
        
        <h2 class="mb-4 font-weight-bolder text-dark" style="font-size: 2rem;">
            Selamat Datang di <?php echo e(isset($company) && $company->NamaPartner ? $company->NamaPartner : 'Klinik'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-kiosk').click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('klinik-kiosk.ambil')); ?>",
                    type: "POST",
                    data: { tipe: tipe },
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/klinik/kiosk/index.blade.php ENDPATH**/ ?>