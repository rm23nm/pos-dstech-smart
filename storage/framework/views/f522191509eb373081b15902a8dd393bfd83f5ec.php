       ...
       <div class="row align-items-center" style="height: 52px;">
           <div class="col-xl-4 col-lg-4 col-md-6 d-flex align-items-center" style="position: relative;">
               ...
               <div class="greeting-text" style="margin-left: 105px !important; background: linear-gradient(135deg, rgba(9, 76, 180, 0.06) 0%, rgba(0, 188, 255, 0.06) 100%) !important; border: 1.5px solid rgba(9, 76, 180, 0.2) !important;">
                ...
                <span class="font-weight-bolder text-dark" style="font-size: 0.85rem;"><?php echo e(Auth::user()->name ?? 'Kasir'); ?></span>
               </div>
           </div>
            ...
            <div class="d-flex justify-content-end align-items-center gap-2">
             ...
             <div class="dropdown">
                 ...
                 <div class="dropdown-menu dropdown-menu-right" id="logoutDropdown" style="position:absolute; right:0; top:45px; background:white; border:1px solid #ddd; border-radius:8px; padding:10px;">
                     <a href="<?php echo e(route('logout')); ?>" class="dropdown-item text-danger font-bold" style="text-decoration:none;"><i class="fas fa-power-off"></i> Logout</a>
                 </div>
             </div>
            </div>
           </div>
    ...
    <div class="col-left">
        ...
        <div class="item-grid-container">
            <div class="item-grid">
                ...
                ?>
                <div class="item-card <?php echo e($itemClass); ?>" onclick="addToCart('<?php echo e($item->KodeItem); ?>', '<?php echo e(addslashes($item->NamaItem)); ?>', <?php echo e($item->HargaJual); ?>, '<?php echo e($itemType); ?>')">
                    <?php if($item->Gambar): ?>
                        <?php
                            $imgSrc = str_starts_with($item->Gambar, 'http') ? $item->Gambar : asset('assets/img/item/' . $item->Gambar);
                        ?>
                        <img src="<?php echo e($imgSrc); ?>" class="item-img" onerror="this.src='https://placehold.co/150x100/bae6fd/0284c7?text=<?php echo e($itemType); ?>'">
                    <?php else: ?>
                        <div style="height:90px; background:<?php echo e($isMemberItem ? '#bbf7d0' : '#bae6fd'); ?>; border-radius:8px; margin-bottom:10px; display:flex; align-items:center; justify-content:center; color:<?php echo e($isMemberItem ? '#15803d' : '#0284c7'); ?>;">
                            <i class="fas <?php echo e($isMemberItem ? 'fa-id-card' : 'fa-ticket-alt'); ?> fa-3x"></i>
                        </div>
                    <?php endif; ?>
                    <div class="item-name"><?php echo e($item->NamaItem); ?></div>
                    <div class="item-price">Rp <?php echo e(number_format($item->HargaJual, 0, ',', '.')); ?></div>
                </div>
...
<!-- KANAN: Keranjang -->
    <div class="col-right">
        ...
        <div class="cart-items" id="cart-items">
            ...
            <div class="d-flex justify-content-between mb-1 text-slate-600">
                <span>Pajak PPN (<span id="lblPpn"><?php echo e($company->PPN ?? 0); ?></span>%)</span>
                <span id="cart-ppn" class="font-bold">Rp 0</span>
            </div>
            <div class="d-flex justify-content-between mb-1 text-slate-600">
                <span>Pajak Hiburan (<span id="lblPb1"><?php echo e($company->PB1 ?? 0); ?></span>%)</span>
...
<script src="<?php echo e(env('MIDTRANS_IS_PRODUCTION', false) ? 'https://app.midtrans.com/snap/snap.js' : 'https://app.sandbox.midtrans.com/snap/snap.js'); ?>" data-client-key="<?php echo e($midtransclientkey); ?>"></script>
...
<script>
    ...
    const pelangganList = <?php echo json_encode($pelanggan, 15, 512) ?>;
    ...
    function renderCart() {
        ...
        let ppnRate = parseFloat('<?php echo e($company->PPN ?? 0); ?>') || 0;
        let pb1Rate = parseFloat('<?php echo e($company->PB1 ?? 0); ?>') || 0;
    ...
    function processPayment() {
        ...
        let ppnRate = <?php echo e($company->PPN ?? 0); ?>;
        let pb1Rate = <?php echo e($company->PB1 ?? 0); ?>;
            ...
            success: function(res) {
                ...
                if (res.success) {
                    ...
                    Swal.fire({
                        ...
                        let printUrl = "<?php echo e(url('')); ?>/ticketing-pos/printthermal/" + res.invoiceNo;
            ...
            <div class="modal-body" style="background:#f8fafc; padding:20px;">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label class="text-sm font-bold text-slate-600" style="display:none;">Pajak (PPN <span id="lblPpn"><?php echo e($company->PPN ?? 0); ?></span>%)</label>
                            
                            
                        </div>
                        <div class="form-group mb-3">
                            <label class="text-sm font-bold text-slate-600" style="display:none;">Pajak Hiburan (<span id="lblPb1"><?php echo e($company->PB1 ?? 0); ?></span>%)</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="chkMetodeBayar" style="border-color:#bae6fd; font-weight:bold;">
                                <?php $__currentLoopData = $metodePembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mb->id); ?>" data-type="<?php echo e($mb->TipePembayaran); ?>"><?php echo e($mb->NamaMetodePembayaran); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group mb-3">
            ...
            <div style="flex:1; overflow:hidden; padding:20px; display:flex; gap:20px;">
                ...
                <div style="flex:1; min-width:0; display:flex; flex-direction:column; border-right:1px solid #f0f0f0; padding-right:10px;">
                    ...
                    <div style="padding:15px; display:grid; grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); gap:15px; overflow-y:auto;" id="fnbQuickGrid">
                        <?php $__currentLoopData = $fnbItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/TicketingPoS.blade.php ENDPATH**/ ?>