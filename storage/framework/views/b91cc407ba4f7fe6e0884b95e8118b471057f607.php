                    ...
                    <div class="card-body">
                        ...
                        <div class="cycle-wrapper">
                            <div class="cycle-grid">
                                ...
                                <a href="<?php echo e(route('klinik-kiosk')); ?>" target="_blank" class="cycle-card">
                                    ...
                                    <div class="cycle-desc">Pasien mengambil nomor antrean awal melalui Kiosk. <br>
                                        ...
                                        <small class="text-info mt-1 d-block" onclick="event.preventDefault(); window.open('<?php echo e(route('klinik-display')); ?>', '_blank');"><i class="fas fa-tv"></i> Buka Layar TV</small>
                                    </div>
                                </a>

                                <!-- Step 2: Pendaftaran -->
                                <a href="<?php echo e(route('klinik-appointments')); ?>" class="cycle-card">
                                ...
                                <div onclick="window.location.href='<?php echo e(route('klinik-emr')); ?>'" class="cycle-card" style="cursor: pointer;">
                                    ...
                                    <div class="dropdown mt-3" onclick="event.stopPropagation();">
                                        ...
                                        <ul class="dropdown-menu shadow">
                                            <?php if(isset($polis) && count($polis) > 0): ?>
                                                <?php $__currentLoopData = $polis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a class="dropdown-item py-2" href="javascript:void(0)" onclick="window.open('<?php echo e(route('klinik-display-poli', ['poli_id' => $p->id])); ?>', '_blank');"><i class="fas fa-desktop text-info mr-2"></i> <?php echo e($p->NamaPoli); ?></a></li>
                                ...
                                <!-- Step 5: Pembayaran -->
                                <a href="<?php echo e(url('transaksi')); ?>" class="cycle-card">
...
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/klinik/dashboard/index.blade.php ENDPATH**/ ?>