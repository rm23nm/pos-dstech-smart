...
<script type="text/javascript">
	...
	function getData() {
		$.ajax({
      		async:false,
      		type: 'post',
			url: "<?php echo e(route('docnum-ViewJson')); ?>",
			headers: {
		...
		var dataGridInstance = jQuery("#gridContainerDocNum").dxDataGrid({
            ...
            onRowUpdated:function (e) {
            	...
            	$.ajax({
		      		async:false,
		      		type: 'POST',
					url: "<?php echo e(route('docnum-store')); ?>",
					headers: {
		                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
		            },
		            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/setting/DocumentNumbering.blade.php ENDPATH**/ ?>