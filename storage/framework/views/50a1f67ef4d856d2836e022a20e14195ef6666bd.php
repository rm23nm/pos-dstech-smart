...
<head>
    ...
    <title>Counter Monitor Apotek - xPOS</title>
...
<body>
    ...
    <header>
        <div class="brand"><i class="bi bi-display"></i> COUNTER APOTEK</div>
    ...
    <script>
        ...
        function fetchData() {
            $.ajax({
                url: "<?php echo e(route('queue-apotek-getData')); ?>",
                method: "POST",
                data: {
        ...
        function renderGrid(items) {
            ...
            if (!items || items.length === 0) {
                container.html('<div id="empty-state"><i class="bi bi-inbox" style="font-size: 4rem;"></i><h3>Tidak ada obat siap diambil</h3></div>');
                return;
            }
                ...
                html += `
                    <div class="order-card" id="card-${item.NoTransaksi}">
                        <div class="order-header">
                            ...
                            <div class="table-info">${item.NoTransaksi}</div>
                        </div>
        ...
        function recallOrder(noTrx) {
            $.ajax({
                url: "<?php echo e(route('queue-apotek-recall')); ?>",
                method: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    NoTransaksi: noTrx
        ...
        function finishOrder(noTrx) {
            Swal.fire({
                ...
                text: "Antrean ini akan dihapus dari layar monitor.",
                icon: "question",
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/CounterMonitorApotek.blade.php ENDPATH**/ ?>