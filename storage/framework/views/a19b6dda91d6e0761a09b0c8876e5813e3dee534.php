...
<head>
	...
	<link href="<?php echo e(asset('api/mcustomscrollbar/jquery.mCustomScrollbar.css')); ?>" rel="stylesheet" type="text/css" />
	
	
	<link href="<?php echo e(asset('api/datatable/jquery.dataTables.min.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<style type="text/css">
		...
		body {
			...
			background: radial-gradient(at 0% 0%, rgba(11, 87, 208, 0.12) 0px, transparent 50%),
			            ...
			            url('<?php echo e(asset("images/misc/bg-login3.jpg")); ?>') !important;
		   ...
		   <div class="row align-items-center" style="height: 52px;">
			   <div class="col-xl-4 col-lg-4 col-md-6 d-flex align-items-center" style="position: relative;">
				   ...
				   <div class="logo-container" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%);">
					   ...
					   <?php if(!empty($companyData[0]['icon'])): ?>
						   <img src="<?php echo e($companyData[0]['icon']); ?>" alt="Logo" style="height: 42px; max-width: 90px; object-fit: contain; border-radius: 8px; box-shadow: 0 4px 12px rgba(9, 76, 180, 0.15); background: white; border: 1.5px solid rgba(9, 76, 180, 0.2); padding: 2px;">
					   <?php else: ?>
						   <img src="<?php echo e(asset('images/misc/LogoFront.png')); ?>" alt="Logo" style="height: 42px; max-width: 90px; object-fit: contain; border-radius: 8px; box-shadow: 0 4px 12px rgba(9, 76, 180, 0.15); background: white; border: 1.5px solid rgba(9, 76, 180, 0.2); padding: 2px;">
					   <?php endif; ?>
				   </div>
				   <div class="greeting-text" style="margin-left: 105px !important; background: linear-gradient(135deg, rgba(9, 76, 180, 0.06) 0%, rgba(0, 188, 255, 0.06) 100%) !important; border: 1.5px solid rgba(9, 76, 180, 0.2) !important;">
					...
					<span class="font-weight-bolder text-dark" style="font-size: 0.85rem;"><?php echo e(Auth::user()->name); ?></span>
				   </div>
			   </div>
	    ...
	    <div class="container-fluid pt-2">
			...
			<div class="row">
					...
					<div class="card card-custom gutter-b bg-white border-0 mb-3" style="flex-grow: 1; overflow: hidden; display: flex; flex-direction: column; border-radius: 24px !important;">
						<div class="card-header border-0 py-2 d-flex flex-column gap-2" style="background: rgba(255,255,255,0.95); border-radius: 24px 24px 0 0;">
							...
							<div class="d-flex gap-2 overflow-auto py-1 scrollbar-1" style="white-space: nowrap;">
								...
								<?php $__currentLoopData = $jenisitem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<button class="btn btn-sm btn-outline-secondary rounded-pill px-4 cat-pill" data-category="<?php echo e($ko->KodeJenis); ?>" style="font-weight: 700; font-size: 0.8rem;"><?php echo e($ko->NamaJenis); ?></button>
				...
				<div class="col-xl-3 col-lg-3 col-md-12 d-flex flex-column" style="height: calc(100vh - 105px) !important; margin-bottom: 0px !important;">
					...
					<input type="hidden" id="KodeSales" value="<?php echo e(Auth::user()->KodeSales ?? ''); ?>">
								...
								<div class="card-body px-0">
									<div class="scroll-container list-group scrollbar-1">
										<ul class="horizontal-list">
											...
											<?php $__currentLoopData = $metodepembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between py-2" StsPyment=<?php echo e($ko->Active); ?> id=<?php echo e($ko->id); ?> CaraVerifikasi=<?php echo e($ko->MetodeVerifikasi); ?> TipePembayaran=<?php echo e($ko->TipePembayaran); ?>>
				...
				<div class="col-md-12">
					...
					<fieldset class="form-group mb-12">
						<select class="arabic-select select-down Select2-Selector" id="KodeItemJasa" name="KodeItemJasa" tabindex="-1">
							...
							<?php $__currentLoopData = $itemServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($ko->KodeItem); ?>">
	                                <?php echo e($ko->NamaItem); ?>
            		...
            		<div class="col-md-6">
            			...
            			<fieldset class="form-group mb-3">
            				<select name="ModalKodeGrupPelanggan" id="ModalKodeGrupPelanggan" class="js-example-basic-single js-states form-control bg-transparent" name="state" required="">
								...
								<?php $__currentLoopData = $gruppelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($ko->KodeGrup); ?>">
                                        <?php echo e($ko->NamaGrup); ?>
            		...
            		<div class="col-md-3">
            			...
            			<fieldset class="form-group mb-3">
            				<select name="ModalProvID" id="ModalProvID" class="js-example-basic-single js-states form-control bg-transparent" name="state" >
								...
								<?php $__currentLoopData = $provinsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($ko->prov_id); ?>">
                                        <?php echo e($ko->prov_name); ?>
							...
							<div class="card-body px-0 py-1">
								<div class="scroll-container list-group scrollbar-1">
									<ul class="horizontal-list tipeorder d-flex flex-wrap gap-3 p-0" style="list-style: none;">
										<?php $__currentLoopData = $tipeorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<li class="list-group-item list-group-item-action border d-flex align-items-center justify-content-center p-3 text-center" style="width: calc(33.333% - 11px); border-radius: 18px; cursor: pointer; transition: all 0.2s ease; flex-direction: column; gap: 8px;" id="<?php echo e($ko->id); ?>" NamaJenisOrder="<?php echo e($ko->NamaJenisOrder); ?>" DineIn="<?php echo e($ko->DineIn); ?>">
												<span class="d-flex align-items-center justify-content-center rounded-circle w-50px h-50px bg-light text-primary">
													<img src="<?php echo e($ko->Icon); ?>" class="bi bi-lightning-fill" width="60%">
												</span>
												<span class="list-title text-dark font-weight-bold" style="font-size: 0.88rem;"><?php echo e($ko->NamaJenisOrder); ?></span>
											</li>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</ul>
								</div>
							...
							<div class="card-body px-0 py-1">
								<div class="scroll-container list-group scrollbar-1" style="max-height: 380px; overflow-y: auto;">
									<ul class="horizontal-list-meja nomormeja d-flex flex-wrap gap-3 p-0" style="list-style: none;">
										<?php $__currentLoopData = $meja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php
											...
											?>
											<li class="list-group-item list-group-item-action border d-flex align-items-center justify-content-center p-3 text-center" style="width: calc(25% - 12px); border-radius: 18px; cursor: pointer; transition: all 0.2s ease; flex-direction: column; gap: 8px;" id="<?php echo e($ko->KodeMeja); ?>" NamaMeja="<?php echo e($ko->NamaMeja); ?>">
												<span class="d-flex align-items-center justify-content-center rounded-circle w-50px h-50px" style="background: <?php echo e($iconBgColor); ?>; color: <?php echo e($textColor); ?>; transition: all 0.2s ease;">
													<img src="<?php echo e(url('images/default/dining-table.png')); ?>" class="bi bi-lightning-fill" width="60%" style="filter: drop-shadow(0px 1px 2px rgba(0,0,0,0.1));">
												</span>
												<div class="d-flex flex-column align-items-center">
													<span class="list-title text-dark font-weight-bold" style="font-size: 0.88rem;"><?php echo e($ko->NamaMeja); ?></span>
													<span class="mt-1 px-2 py-0.5 status-badge" style="font-size: 0.65rem; font-weight: 700; color: <?php echo e($textColor); ?>; border-radius: 6px; background: <?php echo e($iconBgColor); ?>; text-transform: uppercase; letter-spacing: 0.2px;">
														<?php echo e($statusLabel); ?>

													</span>
													<?php if($isNyala && !empty($ko->LampuID)): ?>
														<button type="button" class="btn btn-sm btn-danger rounded-pill mt-2 py-0 px-3" style="font-size: 0.6rem; letter-spacing: 0.5px;" onclick="turnOffTableLight(event, this, <?php echo e($ko->LampuID); ?>)"><i class="fas fa-power-off me-1"></i>Matikan</button>
													<?php endif; ?>
												</div>
											</li>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script src="<?php echo e(asset('js/plugin.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/bootstrap.bundle.min.js')); ?>"></script>
<!-- <script src="http://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js"></script> -->
<!-- <script src="https://unpkg.com/multiple-select@1.5.2/dist/multiple-select.min.js"></script> -->
<!-- <script src="<?php echo e(asset('js/sweetalert.js')); ?>"></script> -->
<!-- <script src="<?php echo e(asset('js/sweetalert1.js')); ?>"></script> -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="<?php echo e(asset('api/jqueryvalidate/jquery.validate.min.js')); ?>"></script>
<script src="<?php echo e(asset('api/mcustomscrollbar/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
<script src="<?php echo e(asset('api/datatable/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/script.bundle.js')); ?>"></script>
<link href="<?php echo e(asset('devexpress/dx.light.css')); ?>" rel="stylesheet" type="text/css" />
<script src="<?php echo e(asset('devexpress/dx.all.js')); ?>"></script>
...
<?php else: ?>
<script src="<?php echo e(env('MIDTRANS_PROD_URL')); ?>" data-client-key="<?php echo e(config('midtrans.client_key')); ?>"></script>
<?php endif; ?>
...
<script type="text/javascript">
	...
	function loadCatalogProducts() {
		...
		$.ajax({
			type: 'post',
			url: "<?php echo e(route('menu-ViewJson')); ?>",
			headers: {
	...
	function renderCatalog(products) {
		...
		products.forEach(function(item) {
			...
			var imgUrl = item.Gambar ? (item.Gambar.startsWith('http://') || item.Gambar.startsWith('https://') || item.Gambar.startsWith('data:') ? item.Gambar : `<?php echo e(asset('assets/img/item')); ?>/${item.Gambar}`) : `https://placehold.co/150x100/e2e8f0/475569?text=${encodeURIComponent(item.NamaItem)}`;
	...
	jQuery(function () {
		jQuery(document).ready(function() {
			...
			let url = new URL("<?php echo e(url('')); ?>");
	    	LoadDraftOrderList();
		...
		$('#_Barcode').on("keypress", function(e) {
	        ...
	        if (e.keyCode == 13) {
	            $.ajax({
		            async:false,
		            type: 'post',
		            url: "<?php echo e(route('itemmaster-ViewJson')); ?>",
		            headers: {
		            ...
		            success: function(response) {
		            	if (false) { // Disabled shipping/product lookup modal since catalog is already visible on the side
		            		...
		            		if (exactMatches.length > 0) {
								clickCatalogProduct(exactMatches[0]['KodeItem']);
		            		}
		            		else{
		            			Swal.fire({
			                      icon: "error",
		...
		jQuery('#KodePelanggan').change(function () {
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('pelanggan-viewJson')); ?>",
	            headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
	            data: {
		...
		jQuery('#ModalProvID').change(function () {
			$.ajax({
                async   : false,
                type    : "post",
                url     : "<?php echo e(route('demografipelanggan')); ?>",
                data    : {
                            'Table' : 'dem_kota',
                            'Field' : 'prov_id',
		...
		jQuery('#btSaveAddCustomer').click(function () {
			$.ajax({
                async   : false,
                type    : "post",
                url     : "<?php echo e(route('pelanggan-storeJson')); ?>",
                headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
                data    : {
	...
	function PrintStruk(NoTransaksi) {
		...
		if(_Printer["PrinterInterface"] == "Bluetooth"){
			$.ajax({
				async:false,
				url: "<?php echo e(route('print-retail')); ?>",
				type: 'POST',
				headers: {
					'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
				},
	...
	function CalculateDiskon(KodeItem, Qty) {
		...
		$.ajax({
            async:false,
            type: 'post',
            url: "<?php echo e(route('fpenjualan-getDiskon')); ?>",
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
            },
            data: {
	...
	function SaveData(Status, ButonObject, ButtonDefaultText) {
		...
		$.ajax({
			async:false,
			url: (NoTransaksi) == "" ? "<?php echo e(route('fpenjualan-retailPosFnB')); ?>" : "<?php echo e(route('fpenjualan-editJsonPosFnB')); ?>",
			type: 'POST',
	...
	function PaymentGateWay(Status, ButonObject, ButtonDefaultText) {
		...
		fetch( "<?php echo e(route('pembayaranpenjualan-createpayment')); ?>", {
			method: 'POST',
			headers: {
	...
	function CalculateTotal() {
		...
		rowsItem.forEach(function(row) {
			...
			var namaTambahan = [];
			var rowsVariantThis = document.querySelectorAll('#AppendArea tr#VariantSectionData[class~="' + RowKodeItem + '"]');
			var rowsAddonThis = document.querySelectorAll('#AppendArea tr#AddonSectionData[class~="' + RowKodeItem + '"]');
    ...
    function editDraft(NoTransaksi) {
    	...
    	$.ajax({
			async:false,
			url: "<?php echo e(route('fpenjualan-findheader')); ?>",
			type: 'POST',
			headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
    ...
    function editDataTransaksi(NoTransaksi, Status) {
    	$.ajax({
			async:false,
			url: "<?php echo e(route('fpenjualan-editStatus')); ?>",
			type: 'POST',
			headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
            },
	...
	function openCustomerDisplay() {
		...
		const url = "<?php echo e(url('/fpenjualan/custdisplay')); ?>";
	...
	function turnOffTableLight(e, btnElement, lampuId) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				jQuery.ajax({
					url: "<?php echo e(url('titiklampu/power-off')); ?>/" + lampuId,
					type: 'GET',
					success: function() {
...
</script><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/PoS/FnBPoS.blade.php ENDPATH**/ ?>