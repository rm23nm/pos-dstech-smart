	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item"><a href="<?php echo e(route('dashboardadmin')); ?>" class="text-muted">Admin</a></li>
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div>
								...
								<h3 class="font-weight-bolder text-dark-75 mt-2 mb-0">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
							</div>
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div>
								...
								<h3 class="font-weight-bolder text-dark-75 mt-2 mb-0"><?php echo e($totalClients); ?> Mitra</h3>
							</div>
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div>
								...
								<h3 class="font-weight-bolder text-dark-75 mt-2 mb-0">Rp <?php echo e(number_format($appStats['smartpro']['revenue'] ?? 0, 0, ',', '.')); ?></h3>
							</div>
					...
					<div class="card-body">
						<div class="d-flex align-items-center justify-content-between">
							<div>
								...
								<h3 class="font-weight-bolder text-dark-75 mt-2 mb-0">Rp <?php echo e(number_format($appStats['masjidku']['revenue'] ?? 0, 0, ',', '.')); ?></h3>
							</div>
...
<script type="text/javascript">
    ...
    function GetLedgerData() {
        $.ajax({
            type: 'post',
            url: "<?php echo e(route('dstechgloballedger-data')); ?>",
            headers: {
    ...
    jQuery("#btnSendBroadcast").click(function() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo e(route('dstechgloballedger-broadcast')); ?>",
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
            data: {
...
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Admin/DstechGlobalDashboard.blade.php ENDPATH**/ ?>