    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            table = jQuery('#dataTable').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url: "<?php echo e(route('dashboard-mekanik.getData')); ?>",
                    type: "POST",
                    data: function (d) {
        ...
        function openUpdateModal(id, noPKB, status, laporan, keluhanStr, mekanikCode) {
            ...
            jQuery.ajax({
                url: "<?php echo e(url('dashboard-mekanik/items')); ?>/" + noPKB,
                type: "GET",
        ...
        function saveUpdate() {
            ...
            jQuery.ajax({
                url: "<?php echo e(url('dashboard-mekanik/update')); ?>/" + id,
                type: 'POST',
                data: formData,
                success: function(res) {
                    if(res.success) {
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/MasterData/DashboardMekanik/index.blade.php ENDPATH**/ ?>