				...
				<div class="row">
					<div class="col-12 px-4">
						<div class="card card-custom gutter-b bg-white border-0" >
							<div class="card-body" >
								<form action="<?php echo e(url('daftartableorder')); ?>" method="GET">
									<div class="row align-items-end">
										<div class="col-md-3">
											<div class="form-group mb-0">
												<label class="text-body">Tanggal Awal</label>
												<input type="date" name="TglAwal" class="form-control" value="<?php echo e($tglAwal); ?>">
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group mb-0">
												<label class="text-body">Tanggal Akhir</label>
												<input type="date" name="TglAkhir" class="form-control" value="<?php echo e($tglAkhir); ?>">
											</div>
										</div>
										<div class="col-md-2">
										...
										<tbody>
											<?php if(count($data) > 0): ?>
												...
												<tr>
													...
													<td><?php echo e(date('d-m-Y', strtotime($v->TglTransaksi))); ?></td>
                                                    <td><?php echo e($v->NamaPelanggan ?? '-'); ?></td>
                                                    <?php
                                                    ...
                                                    ?>
													<td><?php echo e($paketNama); ?></td>
													<td><?php echo e($v->NamaTable); ?></td>
                                                    <td><?php echo e($v->JamMulai ? date('H:i', strtotime($v->JamMulai)) : '-'); ?></td>
                                                    <td><?php echo e($v->JamSelesai ? date('H:i', strtotime($v->JamSelesai)) : '-'); ?></td>
													...
													<td>
														<div class="card-toolbar text-end">
                                                            <?php if($v->Status == 1): ?>
                                                                <form action="<?php echo e(url('daftartableorder/reset')); ?>" method="POST" style="display:inline;">
                                                                    <?php echo csrf_field(); ?>
                                                                    <input type="hidden" name="NoTransaksi" value="<?php echo e($v->NoTransaksi); ?>">
...
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Admin/DaftarTableOrder.blade.php ENDPATH**/ ?>