...
<body>
    ...
    <header>
        <div style="display: flex; align-items: center;">
            <?php if(!empty($company->icon)): ?>
                <img src="<?php echo e($company->icon); ?>" alt="Logo" style="width: 50px; height: 50px; border-radius: 50%; margin-right: 15px; object-fit: cover;">
            <?php else: ?>
            ...
            <?php endif; ?>
            <div class="brand"><?php echo e($company->NamaPartner ?? 'Apotek'); ?></div>
        </div>
    ...
    <div class="running-text-container">  
        <marquee><?php echo e($company->RunningTextSelfServices ?? 'Selamat Datang di Apotek Kami'); ?></marquee>
    </div>
    ...
    <audio id="audio-bell" src="<?php echo e(asset('assets/audio/airport_bell.mp3')); ?>" preload="auto"></audio>
...
<?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/QueueApotek.blade.php ENDPATH**/ ?>