    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="cta-group">
                ...
                <a href="<?php echo e(asset('downloads/dsms-pos.apk')); ?>" download class="btn-outline"><i class="fab fa-android"></i> Download App Mobile</a>
                <a href="<?php echo e(asset('downloads/Setup_DSMS_POS.exe')); ?>" download class="btn-outline"><i class="fab fa-windows"></i> Download App Desktop</a>
            </div>
        </div>
