...
<body>
    ...
    <section class="pricing" id="pricing">
        ...
        <div class="pricing-grid" id="package-grid">
            <?php $__currentLoopData = $subscriptionheader; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="pricing-card reveal package-item" data-type="<?php echo e($item->JenisUsaha); ?>" data-duration="<?php echo e($item->LamaSubsription); ?>">
                ...
                <a href="<?php echo e(route('daftar')); ?>?package=<?php echo e($item->NoTransaksi); ?>&type=<?php echo e($item->JenisUsaha); ?>" class="btn-buy">Beli Paket</a>
            </div>
