		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-white mb-0 px-0 py-2">
				<li class="breadcrumb-item active" aria-current="page">
					<a href="<?php echo e(route('companysetting')); ?>">Setting Data Perusahaan</a>
				</li>
			</ol>
		</nav>
	</div>
				...
				<div class="row">
					<div class="col-12  px-4">
						<div class="card card-custom gutter-b bg-white border-0" >
							<div class="card-body" >
								<form action="<?php echo e(route('companysetting-edit')); ?>" method="post" id="formCompanySetting">	
									<?php echo csrf_field(); ?>
									<div class="row">
										<div class="col-md-3">
											<ul class="nav flex-column nav-pills mb-3" id="v-pills-tab1" role="tablist" aria-orientation="vertical">
												<?php if($company[0]['isActive'] == 0): ?>
													<li class="nav-item" >
													...
													<?php if($company[0]['JenisUsaha'] == "Hiburan" || $company[0]['JenisUsaha'] == "FnB"): ?>
													<li class="nav-item" >
													...
													<?php endif; ?>
													<?php if(in_array($company[0]['JenisUsaha'], ["Retail", "Bengkel", "Servis"])): ?>
													<li class="nav-item" >
													...
													<?php if($company[0]['JenisUsaha'] == "Hiburan"): ?>
													<li class="nav-item" >
											...
											<div class="tab-content" id="v-pills-tabContent1">
													...
													<div class="form-group row">
														...
														<div class="col-md-12"> 
															<fieldset class="form-group mb-3">
																<textarea id = "image_base64" name = "image_base64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['icon'] : ''); ?></textarea>
																...
																<div class="xContainer">
																	<div id="image_result" class="image_result">
																		<?php if(count($company) > 0): ?>
																			<img src=" <?php echo e($company[0]['icon']); ?> ">
																		<?php else: ?>
														...
														<div class="col-md-3">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="KodePartner" name="KodePartner" placeholder="Masukan Kode KelompokRekening" value="<?php echo e(count($company) > 0 ? $company[0]['KodePartner'] : ''); ?>"  readonly="" >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-9">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="NamaPartner" name="NamaPartner" placeholder="Masukan Nama Perusahaan" value="<?php echo e(count($company) > 0 ? $company[0]['NamaPartner'] : ''); ?>"  >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="JenisUsaha" id="JenisUsaha" class="js-example-basic-single js-states form-control bg-transparent">
					                            					<option value="" <?php echo e(count($company) > 0 ? $company[0]['JenisUsaha'] == '' ? 'selected' : '' : ''); ?>>Pilih Jenis Usaha</option>
					                            					<option value="Retail" <?php echo e(count($company) > 0 ? $company[0]['JenisUsaha'] == 'Retail' ? 'selected' : '' : ''); ?>>Retail</option>
					                            					<option value="FnB" <?php echo e(count($company) > 0 ? $company[0]['JenisUsaha'] == 'FnB' ? 'selected' : '' : ''); ?>>Food and Beverage</option>
					                            					<option value="Hiburan" <?php echo e(count($company) > 0 ? $company[0]['JenisUsaha'] == 'Hiburan' ? 'selected' : '' : ''); ?>>Hiburan</option>
					                            				</select>
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-12">
					                            				<textarea class="form-control" id="AlamatTagihan" name="AlamatTagihan" rows="3" placeholder="Masukan Alamat"><?php echo e(count($company) > 0 ? $company[0]['AlamatTagihan'] : ''); ?></textarea>
					                            			</fieldset>
					                            		</div>
					                            		...
					                            		<div class="col-md-4">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="NoTlp" name="NoTlp" placeholder="Masukan Nomor Telephone" value="<?php echo e(count($company) > 0 ? $company[0]['NoTlp'] : ''); ?>"  >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-4">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="NoHP" name="NoHP" placeholder="Masukan Nomor Handphone" value="<?php echo e(count($company) > 0 ? $company[0]['NoHP'] : ''); ?>"  >
					                            			</fieldset>
														...
														<div class="col-md-4">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="Email" name="Email" placeholder="Masukan Nomor Email" value="<?php echo e(count($company) > 0 ? ($company[0]['Email'] == '' ? ($userdata ? $userdata->email : Auth::user()->email) : $company[0]['Email']) : ''); ?>"  >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="date" class="form-control" id="StartSubs" name="StartSubs" placeholder="Masukan Nomor Handphone" value="<?php echo e(count($company) > 0 ? $company[0]['StartSubs'] : ''); ?>" readonly="" >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="date" class="form-control" id="EndSubs" name="EndSubs" placeholder="Masukan Nomor Handphone" value="<?php echo e(count($company) > 0 ? $company[0]['EndSubs'] : ''); ?>" readonly="" >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="text" class="form-control" id="NPWP" name="NPWP" placeholder="Masukan Nomor NPWP" value="<?php echo e(count($company) > 0 ? $company[0]['NPWP'] : ''); ?>">
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="date" class="form-control" id="TglPKP" name="TglPKP" placeholder="Masukan Nomor Handphone" value="<?php echo e(count($company) > 0 ? $company[0]['TglPKP'] : '2000-01-01'); ?>" >
					                            			</fieldset>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<input type="number" class="form-control" id="PPN" name="PPN" placeholder="Masukan Nomor Handphone" value="<?php echo e(count($company) > 0 ? $company[0]['PPN'] : 0); ?>" >
					                            			</fieldset>
					                            			<label for="isHargaJualIncludePPN">Harga Jual Sudah Termasuk PPN</label>
					                            			<input type="checkbox" class="checkbox-input" id="isHargaJualIncludePPN" <?php echo e(count($company) > 0 ? $company[0]['isHargaJualIncludePPN'] == 1 ? 'checked' : '' : ''); ?>>
					                            		...
					                            		<div class="col-md-6">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="isPostingAkutansi" id="isPostingAkutansi" class="js-states form-control bg-transparent" readonly>
					                            					<option value="0" <?php echo e(count($company) > 0 ? $company[0]['isPostingAkutansi'] == 0 ? 'selected' : '' : ''); ?> >Tidak</option>
					                            					<option value="1" <?php echo e(count($company) > 0 ? $company[0]['isPostingAkutansi'] == 1 ? 'selected' : '' : ''); ?>>Ya</option>
					                            				</select>
					                            			</fieldset>
														...
														<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="GudangPoS" id="GudangPoS" class="js-example-basic-single js-states form-control bg-transparent">
																	...
																	<?php $__currentLoopData = $gudang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($ko->KodeGudang); ?>" <?php echo e($ko->KodeGudang == (count($company) > 0 ? $company[0]['GudangPoS'] : '') ? 'selected' : ''); ?>>
								                                            <?php echo e($ko->NamaGudang); ?>
					                            		...
					                            		<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="TerminBayarPoS" id="TerminBayarPoS" class="js-example-basic-single js-states form-control bg-transparent">
																	...
																	<?php $__currentLoopData = $temin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($ko->id); ?>" <?php echo e($ko->id == (count($company) > 0 ? $company[0]['TerminBayarPoS'] : '') ? 'selected' : ''); ?>>
								                                            <?php echo e($ko->NamaTermin); ?>
					                            		...
					                            		<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="AllowNegativeInventory" id="AllowNegativeInventory" class="js-example-basic-single js-states form-control bg-transparent">
																	<option value="N" <?php echo e(count($company) > 0 ? $company[0]['AllowNegativeInventory'] == 'N' ? 'selected' : '' : ''); ?>>TIDAK</option>
																	<option value="Y" <?php echo e(count($company) > 0 ? $company[0]['AllowNegativeInventory'] == 'Y' ? 'selected' : '' : ''); ?>>YA</option>
																</select>
					                            			</fieldset>
					                            		</div>
												...
												<div class="tab-pane fade " id="printer" role="tabpanel" aria-labelledby="printer-tab">
													<div class="form-group row">
														<div class="col-md-4">
					                            			...
					                            			<fieldset class="form-group mb-4">
					                            				<select name="NamaPosPrinter" id="NamaPosPrinter" class="js-example-basic-single js-states form-control bg-transparent">
																	...
																	<?php $__currentLoopData = $printer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option <?php echo e(count($company) > 0 ? $company[0]['NamaPosPrinter'] == $ko->DeviceAddress ? "selected" : '' :""); ?> value="<?php echo e($ko->DeviceAddress); ?>">
					                                                        <?php echo e($ko->NamaPrinter. ' > '. $ko->PrinterInterface); ?>
					                            		...
					                            		<!-- <a href="<?php echo e(url('companysetting/testprint')); ?>">Test Print</a> -->
					                            		<div class="col-md-12">
					                            			<label  class="text-body">Keterangan Footer</label>
					                            			<fieldset class="form-group mb-12">
					                            				<textarea class="form-control" id="FooterNota" name="FooterNota" rows="3" placeholder="Masukan Alamat"><?php echo e(count($company) > 0 ? $company[0]['FooterNota'] : ''); ?></textarea>
					                            			</fieldset>
					                            		</div>
														...
														<div class="col-md-4">
					                            			...
					                            			<fieldset class="form-group mb-3">
					                            				<select name="DefaultSlip" id="DefaultSlip" class="js-example-basic-single js-states form-control bg-transparent">
					                            					<option value="slip1" <?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] == "slip1"? "selected" : '' :""); ?> >Slip 1</option>
					                            					<option value="slip2" <?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] == "slip2"? "selected" : '' :""); ?> >Slip 2</option>
					                            					<option value="slip3" <?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] == "slip3"? "selected" : '' :""); ?> >Slip 3</option>
																	<option value="slip4" <?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] == "slip4"? "selected" : '' :""); ?> >Slip 4</option>
																	<option value="slip5" <?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] == "slip5"? "selected" : '' :""); ?> >Slip 5</option>
					                            				</select>
					                            		</div>
												...
												<div class="tab-pane fade " id="bulkaction" role="tabpanel" aria-labelledby="printer-tab">
													<div class="form-group row">
														<div class="col-md-10">
					                            			<label  class="text-body">Daftar Barang <a href="<?php echo e(asset('sample/BulkItemMaster.xlsx')); ?>">Download Sample</a></label>
					                            			<fieldset class="form-group mb-4">
														...
														<div class="col-md-10">
					                            			<label  class="text-body">Harga Jual <a href="<?php echo e(asset('sample/BulkHargaJual.xlsx')); ?>">Download Sample</a></label>
					                            			<fieldset class="form-group mb-4">
														...
														<div class="col-md-10">
					                            			<label  class="text-body">Pelanggan <a href="<?php echo e(asset('sample/BulkPelanggan.xlsx')); ?>">Download Sample</a></label>
					                            			<fieldset class="form-group mb-4">
														...
														<div class="col-md-10">
					                            			<label  class="text-body">Supplier <a href="<?php echo e(asset('sample/BulkSupplier.xlsx')); ?>">Download Sample</a></label>
					                            			<fieldset class="form-group mb-4">
												...
												<div class="tab-pane fade " id="domain" role="tabpanel" aria-labelledby="domain-tab">
													<div class="row">
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="CustomDomain" placeholder="contoh: order.gorfit.com" value="<?php echo e(count($company) > 0 ? $company[0]['CustomDomain'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="CustomDomainBooking" placeholder="contoh: booking.gorfit.com" value="<?php echo e(count($company) > 0 ? $company[0]['CustomDomainBooking'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="CustomDomainQueue" placeholder="contoh: antrean.gorfit.com" value="<?php echo e(count($company) > 0 ? $company[0]['CustomDomainQueue'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="CustomDomainKDS" placeholder="contoh: dapur.gorfit.com" value="<?php echo e(count($company) > 0 ? $company[0]['CustomDomainKDS'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="MidtransClientKey" placeholder="SB-Mid-client-..." value="<?php echo e(count($company) > 0 ? $company[0]['MidtransClientKey'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="MidtransServerKey" placeholder="SB-Mid-server-..." value="<?php echo e(count($company) > 0 ? $company[0]['MidtransServerKey'] : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-3">
															...
															<fieldset class="form-group mb-3">
																<div class="input-group">
																	<input type="number" class="form-control" name="ExpiredAlertDays" placeholder="90" min="1" max="365" value="<?php echo e(count($company) > 0 ? ($company[0]['ExpiredAlertDays'] ?? 90) : 90); ?>">
														...
														<div class="col-md-9">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="ExpiredAlertWA" placeholder="628123456789,628987654321" value="<?php echo e(count($company) > 0 ? ($company[0]['ExpiredAlertWA'] ?? '') : ''); ?>">
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="SmartproApiKey" placeholder="Masukkan API Key dari akun Smartpro Anda" value="<?php echo e(count($company) > 0 ? ($company[0]['SmartproApiKey'] ?? '') : ''); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" name="SmartproSender" placeholder="628xxx (nomor WA yang terhubung di Smartpro)" value="<?php echo e(count($company) > 0 ? ($company[0]['SmartproSender'] ?? '') : ''); ?>">
															</fieldset>
														</div>
																	...
																	<div class="col-md-4 mb-3 d-none">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="PosTemplate" id="PosTemplate" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="NormalPoS" <?php echo e(count($company) > 0 ? $company[0]['PosTemplate'] == "NormalPoS" ? "selected" : '' :""); ?> >Standard POS (Default)</option>
																				<option value="NormalPoS_Premium" <?php echo e(count($company) > 0 ? $company[0]['PosTemplate'] == "NormalPoS_Premium" ? "selected" : '' :""); ?> >Premium POS (Modern Glow)</option>
																			</select>
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-4 mb-3 d-none">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="TypeBackgraund" id="TypeBackgraund" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="Color" <?php echo e(count($company) > 0 && $company[0]['TypeBackgraund'] == 'Color' ? 'selected' : ''); ?>>Color</option>
																				<option value="Image" <?php echo e(count($company) > 0 && $company[0]['TypeBackgraund'] == 'Image' ? 'selected' : ''); ?>>Image</option>
																			</select>
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-6 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="TypeKitchenBackgraund" id="TypeKitchenBackgraund" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="Color" <?php echo e(count($company) > 0 && $company[0]['TypeKitchenBackgraund'] == 'Color' ? 'selected' : ''); ?>>Color</option>
																				<option value="Image" <?php echo e(count($company) > 0 && $company[0]['TypeKitchenBackgraund'] == 'Image' ? 'selected' : ''); ?>>Image</option>
																			</select>
																		</fieldset>
																	</div>
															...
															<div class="card-body py-4">
																<div class="row">
																	<div class="col-sm-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="PromoDsiplay">
																				<?php echo count($company) > 0 ? $company[0]['PromoDsiplay'] : ''; ?>
																	...
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<input type="text" class="form-control" id="RunningText" name="RunningText" placeholder="Masukan Running Text" value="<?php echo e(count($company) > 0 ? $company[0]['RunningText'] : 0); ?>" >
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="CustDisplayDesignSetting" id="CustDisplayDesignSetting" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="default" <?php echo e((count($company) > 0 && $company[0]['CustDisplayDesignSetting'] == "default") ? "selected" : ""); ?>>Model Standar Premium (Biru-Merah Neon)</option>
																				<option value="model_neon_red" <?php echo e((count($company) > 0 && $company[0]['CustDisplayDesignSetting'] == "model_neon_red") ? "selected" : ""); ?>>Model Neon Merah (Full Red Theme & Neonbox)</option>
																				<option value="model_neon_blue" <?php echo e((count($company) > 0 && $company[0]['CustDisplayDesignSetting'] == "model_neon_blue") ? "selected" : ""); ?>>Model Neon Biru (Full Blue Theme & Neonbox)</option>
																				<option value="model_neon_split" <?php echo e((count($company) > 0 && $company[0]['CustDisplayDesignSetting'] == "model_neon_split") ? "selected" : ""); ?>>Model Neon Split (Merah-Biru Kombinasi Dinamis)</option>
																			</select>
																		</fieldset>
																	</div>
																		...
																		<div class="row">
																			...
																			<div class="col-sm-3 mb-3">
																				<fieldset class="form-group mb-0">
																					<textarea id="ImageCustDisplay<?php echo e($i); ?>Base64" name="ImageCustDisplay<?php echo e($i); ?>Base64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['ImageCustDisplay'.$i] : ''); ?></textarea>
																					<input type="file" id="fileImageCustDisplay<?php echo e($i); ?>" name="fileImageCustDisplay<?php echo e($i); ?>" accept=".jpg, .png" class="btn btn-warning" style="display: none;"/>
																					<div class="xContainer border rounded p-1 text-center bg-light">
																						<div id="ImageCustDisplay<?php echo e($i); ?>" class="image_result_sample" style="height: 120px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
																							<?php if(!empty($company[0]['ImageCustDisplay'.$i])): ?>
																								<img src="<?php echo e($company[0]['ImageCustDisplay'.$i]); ?>" style="max-height: 100%; max-width: 100%;">
																							<?php else: ?>
																						...
																						<span class="text-muted d-block mt-1 font-size-xs">Slide #<?php echo e($i); ?></span>
																					</div>
																				</fieldset>
																			</div>
																			<?php endfor; ?>
																		...
																		<div class="row">
																			...
																			<div class="col-md-6 mb-3">
																				<fieldset class="form-group mb-2">
																					<label class="font-size-sm text-muted">Link/ID Video <?php echo e($v); ?></label>
																					<input type="text" class="form-control" id="VideoCustomerDisplay<?php echo e($v); ?>" name="VideoCustomerDisplay<?php echo e($v); ?>" placeholder="Contoh: IcJCYEZMpwA" value="<?php echo e(count($company) > 0 ? $company[0]['VideoCustomerDisplay'.$v] : ''); ?>" >
																				</fieldset>
																			</div>
																			<?php endfor; ?>
																		</div>
																...
																<div class="row">
																	<div class="col-md-12 mb-3">
																		...
																		<div class="row">
																			...
																			<div class="col-md-6 mb-3">
																				<fieldset class="form-group mb-2">
																					<label class="font-size-sm text-muted">Video Klinik <?php echo e($v); ?> (Tampil di Semua Poli)</label>
																					<input type="text" class="form-control" id="VideoKlinikDisplay<?php echo e($v > 1 ? $v : ''); ?>" name="VideoKlinikDisplay<?php echo e($v > 1 ? $v : ''); ?>" placeholder="Contoh: https://www.youtube.com/embed/... atau link .mp4" value="<?php echo e(count($company) > 0 ? $company[0]['VideoKlinikDisplay' . ($v > 1 ? $v : '')] : ''); ?>" >
																				</fieldset>
																			</div>
																			<?php endfor; ?>
																		</div>
										...
										<div class="row">
											<div class="col-md-12">
												...
												<fieldset class="form-group mb-5">
													<textarea id="KioskBackgroundBase64" name="KioskBackgroundBase64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['KioskBackground'] : ''); ?></textarea>
													...
													<div class="xContainer">
														<div id="KioskBackgroundPreview" class="image_result_sample" style="cursor:pointer;" title="Klik untuk mengubah gambar">
															<?php if(count($company) > 0 && $company[0]['KioskBackground'] != ''): ?>
																<img src="<?php echo e($company[0]['KioskBackground']); ?>" style="max-height: 200px;">
															<?php else: ?>
												...
												<fieldset class="form-group mb-5">
													<a href="<?php echo e(route('klinik-loket.index')); ?>" class="btn btn-outline-primary"><i class="fas fa-list"></i> Atur Daftar Loket Fisik Kiosk</a>
															...
															<div class="card-body py-4">
																...
																<div class="accordion mb-4" id="accordionBanners">
																	...
																	<div class="accordion-item border mb-2 rounded">
																		<h2 class="accordion-header" id="headingBanner<?php echo e($b); ?>">
																			<button class="accordion-button <?php echo e($b > 1 ? 'collapsed' : ''); ?> py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBanner<?php echo e($b); ?>" aria-expanded="<?php echo e($b == 1 ? 'true' : 'false'); ?>" aria-controls="collapseBanner<?php echo e($b); ?>">
																				Banner Promosi #<?php echo e($b); ?>

																			</button>
																		</h2>
																		<div id="collapseBanner<?php echo e($b); ?>" class="accordion-collapse collapse <?php echo e($b == 1 ? 'show' : ''); ?>" aria-labelledby="headingBanner<?php echo e($b); ?>" data-bs-parent="#accordionBanners">
																			<div class="accordion-body">
																				<div class="row">
																					<div class="col-sm-12 mb-3">
																						<label class="text-body fw-bold">Banner Header</label>
																						<fieldset class="form-group mb-2">
																							<div id="BannerHeader<?php echo e($b); ?>">
																								<?php echo count($company) > 0 ? $company[0]['BannerHeader'.$b] : ''; ?>
																					...
																					<div class="col-sm-12 mb-3">
																						...
																						<fieldset class="form-group mb-2">
																							<div id="BannerText<?php echo e($b); ?>">
																								<?php echo count($company) > 0 ? $company[0]['BannerText'.$b] : ''; ?>
																					...
																					<div class="col-sm-12 mb-3">
																						...
																						<fieldset class="form-group mb-2">
																							<textarea id="Banner<?php echo e($b); ?>Base64" name="Banner<?php echo e($b); ?>Base64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['Banner'.$b] : ''); ?></textarea>
																							<input type="file" id="fileBanner<?php echo e($b); ?>" name="fileBanner<?php echo e($b); ?>" accept=".jpg, .png" class="btn btn-warning" style="display: none;"/>
																							<div class="xContainer border rounded p-1 text-center bg-light">
																								<div id="Banner<?php echo e($b); ?>" class="image_result_sample" style="max-height: 200px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
																									<?php if(count($company) > 0 && !empty($company[0]['Banner'.$b])): ?>
																										<img src="<?php echo e($company[0]['Banner'.$b]); ?>" style="max-height: 100%; max-width: 100%;">
																									<?php else: ?>
																...
																<div class="row">
																	<div class="col-md-6 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="DefaultLandingPages" id="DefaultLandingPages" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="bo1" <?php echo e(count($company) > 0 ? $company[0]['DefaultLandingPages'] == "bo1"? "selected" : '' :""); ?> >Template 1</option>
																				<option value="bo2" <?php echo e(count($company) > 0 ? $company[0]['DefaultLandingPages'] == "bo2"? "selected" : '' :""); ?> >Template 2</option>
																			</select>
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-6 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<input type="color" class="form-control" id="DefaultLandingPageColor" name="DefaultLandingPageColor" value="<?php echo e(count($company) > 0 ? $company[0]['DefaultLandingPageColor'] : ''); ?>" >
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<select name="ShowLinkInReciept" id="ShowLinkInReciept" class="js-example-basic-single js-states form-control bg-transparent">
																				<option value="0" <?php echo e(count($company) > 0 ? $company[0]['ShowLinkInReciept'] == '0' ? 'selected' : '' : ''); ?>>Tidak</option>
																				<option value="1" <?php echo e(count($company) > 0 ? $company[0]['ShowLinkInReciept'] == '1' ? 'selected' : '' : ''); ?>>Ya</option>
																			</select>
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-12 mb-4">
																		...
																		<fieldset class="form-group mb-3">
																			<textarea id="BannerBookingBase64" name="BannerBookingBase64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['BannerBooking'] : ''); ?></textarea>
																			...
																			<div class="xContainer border rounded p-1 text-center bg-light">
																				<div id="BannerBooking" class="image_result_sample" style="max-height: 250px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
																					<?php if(count($company) > 0 && !empty($company[0]['BannerBooking'])): ?>
																						<img src="<?php echo e($company[0]['BannerBooking']); ?>" style="max-height: 100%; max-width: 100%;">
																					<?php else: ?>
																						<img src="https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg" style="max-height: 100%; max-width: 100%;">
																					<?php endif; ?>
																				</div>
																	...
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="HeadlineBanner">
																				<?php echo count($company) > 0 ? $company[0]['HeadlineBanner'] : ''; ?>
																	...
																	<div class="col-md-12 mb-4">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="SubHeadlineBanner">
																				<?php echo count($company) > 0 ? $company[0]['SubHeadlineBanner'] : ''; ?>
																	...
																	<div class="col-md-6 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<input type="text" class="form-control" id="JamAwalBooking" name="JamAwalBooking" step="60" value="<?php echo e(count($company) > 0 && $company[0]['JamAwalBooking'] ? date('H:i', strtotime($company[0]['JamAwalBooking'])) : ''); ?>">
																		</fieldset>
																	</div>
																	...
																	<div class="col-md-6 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<input type="text" class="form-control" id="JamAkhirBooking" name="JamAkhirBooking" step="60" value="<?php echo e(count($company) > 0 && $company[0]['JamAkhirBooking'] ? date('H:i', strtotime($company[0]['JamAkhirBooking'])) : ''); ?>">
																		</fieldset>
																	</div>
																</div>
																...
																<div class="row">
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="TermAndCondition">
																				<?php echo count($company) > 0 ? $company[0]['TermAndCondition'] : ''; ?>
																	...
																	<div class="col-md-12 mb-3">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="AboutUs">
																				<?php echo count($company) > 0 ? $company[0]['AboutUs'] : ''; ?>
																	...
																	<div class="col-md-12 mb-4">
																		...
																		<fieldset class="form-group mb-3">
																			<div id="TermAndConditionBookingOnline">
																				<?php echo count($company) > 0 ? $company[0]['TermAndConditionBookingOnline'] : ''; ?>
																...
																<div class="row">
																	...
																	<div class="col-sm-3 mb-4">
																		<fieldset class="form-group mb-0">
																			<textarea id="ImageGallery<?php echo e($g); ?>Base64" name="ImageGallery<?php echo e($g); ?>Base64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['ImageGallery'.$g] : ''); ?></textarea>
																			<input type="file" id="fileImageGallery<?php echo e($g); ?>" name="fileImageGallery<?php echo e($g); ?>" accept=".jpg, .png" class="btn btn-warning" style="display: none;"/>
																			<div class="xContainer border rounded p-1 text-center bg-light">
																				<div id="ImageGallery<?php echo e($g); ?>" class="image_result_sample" style="height: 110px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
																					<?php if(!empty($company[0]['ImageGallery'.$g])): ?>
																						<img src="<?php echo e($company[0]['ImageGallery'.$g]); ?>" style="max-height: 100%; max-width: 100%;">
																					<?php else: ?>
																						<img src="https://png.pngtree.com/png-vector/20221125/ourmid/pngtree-no-image-available-icon-flatvector-illustration-blank-avatar-modern-vector-png-image_40962406.jpg" style="max-height: 100%; max-width: 100%;">
																					<?php endif; ?>
																				</div>
																				<span class="text-muted d-block mt-1 font-size-xs">Galeri #<?php echo e($g); ?></span>
																			</div>
																		</fieldset>
																	</div>
																	<?php endfor; ?>
																...
																<div class="row">
																	<div class="col-md-12 mb-3">
																		...
																		<div class="d-flex align-items-center">
																			<?php if($company[0]['JenisUsaha'] == "Retail"): ?>
																			<a href="<?php echo e(url('cat/').'/'.$company[0]['KodePartner'].'#home-basic'); ?>" target="_blank" class="btn btn-primary font-weight-bold me-3">
																				<i class="flaticon-link me-1"></i> Buka Website
																			</a>
																			<?php else: ?>
																			<a href="<?php echo e(url('fnb-store/').'/'.$company[0]['KodePartner']); ?>" target="_blank" class="btn btn-primary font-weight-bold me-3">
																				<i class="flaticon-link me-1"></i> Buka Website
																			</a>
																			<?php endif; ?>
																			
																			<a href="<?php echo e($BookingURLString ?? '#'); ?>" target="_blank" class="btn btn-outline-primary font-weight-bold">
														...
														<div class="card card-custom gutter-b mb-6 border border-light-info bg-white shadow-sm rounded">
															...
															<div class="card-body py-4">
																...
																<div class="accordion mb-4" id="accordionBannersBengkel">
																	<?php for($b = 1; $b <= 3; $b++): ?>
																	<div class="accordion-item border mb-2 rounded">
																		<h2 class="accordion-header" id="headingBannerBengkel<?php echo e($b); ?>">
																			<button class="accordion-button <?php echo e($b > 1 ? 'collapsed' : ''); ?> py-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBannerBengkel<?php echo e($b); ?>" aria-expanded="<?php echo e($b == 1 ? 'true' : 'false'); ?>" aria-controls="collapseBannerBengkel<?php echo e($b); ?>">
																				Banner Promosi #<?php echo e($b); ?>

																			</button>
																		</h2>
																		<div id="collapseBannerBengkel<?php echo e($b); ?>" class="accordion-collapse collapse <?php echo e($b == 1 ? 'show' : ''); ?>" aria-labelledby="headingBannerBengkel<?php echo e($b); ?>" data-bs-parent="#accordionBannersBengkel">
																			<div class="accordion-body">
																				<div class="row">
																					<div class="col-sm-12 mb-3">
																						<label class="text-body fw-bold">Banner Header</label>
																					...
																					<div class="col-sm-12 mb-3">
																						...
																						<fieldset class="form-group mb-2">
																							...
																							<input type="file" id="fileBanner<?php echo e($b); ?>" name="fileBanner<?php echo e($b); ?>" accept=".jpg, .png" class="btn btn-warning" style="display: none;"/>
																							<div class="xContainer border rounded p-1 text-center bg-light">
																								<div id="Banner<?php echo e($b); ?>_Preview" class="image_result_sample" style="max-height: 200px; overflow: hidden; display: flex; align-items: center; justify-content: center;" onclick="document.getElementById('fileBanner<?php echo e($b); ?>').click();">
																									<?php if(count($company) > 0 && !empty($company[0]['Banner'.$b])): ?>
																										<img src="<?php echo e($company[0]['Banner'.$b]); ?>" style="max-height: 100%; max-width: 100%;">
																									<?php else: ?>
																										<img src="https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg" style="max-height: 100%; max-width: 100%;">
																...
																<div class="row">
																	<div class="col-md-12 mb-3">
																		<div class="d-flex align-items-center">
																			<a href="<?php echo e(count($company) > 0 ? url('booking-bengkel/'.$company[0]['KodePartner']) : '#'); ?>" target="_blank" class="btn btn-outline-primary font-weight-bold">
												...
												<div class="tab-pane fade " id="hiburan" role="tabpanel" aria-labelledby="hiburan-tab">
													<div class="form-group row">
														<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-4">
					                            				<input type="number" class="form-control" step="0.01" id="PajakHiburan" name="PajakHiburan" placeholder="Masukan Pajak Hiburan" value="<?php echo e(count($company) > 0 ? $company[0]['PajakHiburan'] : "0"); ?>" >
					                            			</fieldset>
														...
														<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-4">
					                            				<input type="number" class="form-control" step="1" id="WarningTimer" name="WarningTimer" placeholder="Masukan Warning Hampir Habis" value="<?php echo e(count($company) > 0 ? $company[0]['WarningTimer'] : "0"); ?>" >
					                            			</fieldset>
														...
														<div class="col-md-12">
					                            			...
					                            			<fieldset class="form-group mb-4">
					                            				<select name="ItemHiburan" id="ItemHiburan" class="js-example-basic-single js-states form-control bg-transparent">
					                            					<option value="" <?php echo e(count($company) > 0 ? $company[0]['ItemHiburan'] == ""? "selected" : '' :""); ?> >Pilih Item</option>
																	<?php $__currentLoopData = $itemjasa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $js): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($js->KodeItem); ?>" <?php echo e($js->KodeItem == (count($company) > 0 ? $company[0]['ItemHiburan'] : '') ? 'selected' : ''); ?>>
								                                            <?php echo e($js->NamaItem); ?>
														...
														<div class="col-md-12">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" id="BookingURL" name="BookingURL"
																	value="<?php echo e($QueueURLString); ?>" readonly>
															</fieldset>
														</div>
														...
														<div class="col-md-12">
															...
															<fieldset class="form-group mb-3">
																<input type="text" class="form-control" id="RunningTextSelfServices" name="RunningTextSelfServices" value="<?php echo e(count($company) > 0 ? $company[0]['RunningTextSelfServices'] : ""); ?>">
															</fieldset>
														</div>
														...
														<div class="col-md-4">
															...
															<fieldset class="form-group mb-3">
																<select name="QueueDesignSetting" id="QueueDesignSetting" class="js-example-basic-single js-states form-control bg-transparent">
																	<option value="QueueManagement" <?php echo e(count($company) > 0 ? $company[0]['QueueDesignSetting'] == "QueueManagement"? "selected" : '' :""); ?> >Versi 1</option>
																	<option value="QueueManagement_v2" <?php echo e(count($company) > 0 ? $company[0]['QueueDesignSetting'] == "QueueManagement_v2"? "selected" : '' :""); ?> >Versi 2</option>
																	<option value="QueueManagement_v3" <?php echo e(count($company) > 0 ? $company[0]['QueueDesignSetting'] == "QueueManagement_v3"? "selected" : '' :""); ?> >Versi 3</option>
																</select>
															</fieldset>
														</div>
														...
														<div class="col-md-12">
															<div class="form-group mb-3">
																<label class="checkbox checkbox-outline checkbox-success">
																	<input type="checkbox" id="showBayarDiMeja" name="showBayarDiMeja" <?php echo e((count($company) > 0 && substr($company[0]['ShowMetodePembayaran'] ?? '00', 0, 1) == '1') ? 'checked' : ''); ?>>
																	<span></span>Tampilkan Metode Pembayaran <i><b>Bayar dikasir</b></i> di pemesanan meja
																</label>
															</div>
															<div class="form-group mb-3">
																<label class="checkbox checkbox-outline checkbox-success">
																	<input type="checkbox" id="showLangsungBayar" name="showLangsungBayar" <?php echo e((count($company) > 0 && substr($company[0]['ShowMetodePembayaran'] ?? '00', 1, 1) == '1') ? 'checked' : ''); ?>>
...
<script src="<?php echo e(env('MIDTRANS_DEV_URL')); ?>" data-client-key="<?php echo e(config('midtrans.client_key')); ?>"></script>
...
var oCompany;
	$(function () {
		...
		jQuery(document).ready(function () {
			...
			var slip = "<?php echo e(count($company) > 0 ? $company[0]['DefaultSlip'] : 'slip1'); ?>";
			var template = "<?php echo e(count($company) > 0 ? $company[0]['DefaultLandingPages'] : 'bo1'); ?>";
			...
			var queueDesign = "<?php echo e(count($company) > 0 ? $company[0]['QueueDesignSetting'] : 'QueueManagement'); ?>";
			...
			jQuery('#invoiceTable').DataTable({
				"ajax": {
					"url": "<?php echo e(route('invpengguna-viewpercom')); ?>",
					"type": "POST",
				...
				success: function(response) {
					if(response.success == true){
						swal.fire({
							...
							window.location.href = "<?php echo e(route('companysetting')); ?>";
						});
					} else {
						swal.fire({
							title: 'Error',
		...
		function updateBackgroundInput(type) {
			...
			if (type === 'Image') {
				var imageInputHTML = `
					<fieldset class="form-group mb-3">
						<textarea id="BackgraundBase64" name="BackgraundBase64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['Backgraund'] : ''); ?></textarea>
						...
						<div class="xContainer">
							<div id="BackgraundPreview" class="image_result_sample">
								<?php if(count($company) > 0 && $company[0]['Backgraund'] != ''): ?>
									<img src="<?php echo e($company[0]['Backgraund']); ?>">
								<?php else: ?>
		...
		function updateKitchenBackgroundInput(type) {
			...
			if (type === 'Image') {
				var imageInputHTML = `
					<fieldset class="form-group mb-3">
						<textarea id="KitchenBackgraundBase64" name="KitchenBackgraundBase64" style="display: none;"><?php echo e(count($company) > 0 ? $company[0]['KitchenBackgraund'] : ''); ?></textarea>
						...
						<div class="xContainer">
							<div id="KitchenBackgraundPreview" class="image_result_sample">
								<?php if(count($company) > 0 && $company[0]['KitchenBackgraund'] != '' && $company[0]['TypeKitchenBackgraund'] == 'Image'): ?>
									<img src="<?php echo e($company[0]['KitchenBackgraund']); ?>">
								<?php else: ?>
									<img src="https://png.pngtree.com/png-vector/20221125/ourmid/pngtree-no-image-available-icon-flatvector-illustration-blank-avatar-modern-vector-png-image_40962406.jpg">
								<?php endif; ?>
							</div>
		...
		jQuery('#btTestPrint').click(function () {
			...
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('print-test')); ?>",
	            headers: {
		...
		jQuery('#testPrintUSB').click(function () {
			// window.print();
			let url = new URL("<?php echo e(route('print-testusb48')); ?>");
		...
		jQuery('#DefaultSlip').change(function () {
			...
			console.log();
			// var URL = "<?php echo e(asset("+FileName+")); ?>";
		...
		jQuery('#btInportItem').click(function () {
			...
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('companysetting-importitem')); ?>",
	            headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
	            data: formData,
		...
		jQuery('#btInportHargaJual').click(function () {
			...
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('companysetting-importharga')); ?>",
	            headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
	            data: formData,
		...
		jQuery('#btInportPelanggan').click(function () {
			...
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('companysetting-importpelanggan')); ?>",
	            headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
	            data: formData,
		...
		jQuery('#btInportSupplier').click(function () {
			...
			$.ajax({
	            async:false,
	            type: 'post',
	            url: "<?php echo e(route('companysetting-importsupplier')); ?>",
	            headers: {
	                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
	            },
	            data: formData,
		...
		function PaymentGateWay(ButtonObject, ButtonDefaultText, NoTransaksi, TotalPembelian) {
			...
			fetch( "<?php echo e(route('invpengguna-create-gateway')); ?>", {
				method: 'POST',
				headers: {
						...
						onSuccess: function(result){
							...
							if(result.transaction_status == "cancel"){
								...
								$.ajax({
									async:false,
									type: 'post',
									url: "<?php echo e(route('invpengguna-pay-gateway')); ?>",
									headers: {
										'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
									},
...
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/setting/CompanySetting.blade.php ENDPATH**/ ?>