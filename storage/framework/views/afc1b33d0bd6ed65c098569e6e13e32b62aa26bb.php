						...
						<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
							<div class="card-header align-items-center  border-bottom-dark px-0">
							    ...
							    <div class="icons d-flex">
									<a href="<?php echo e(url('delivery/form/-')); ?>" class="btn btn-outline-primary rounded-pill font-weight-bold me-1 mb-1">Tambah Data</a>
...
<script type="text/javascript">
    ...
    jQuery('#btSimpanDeliveryStatus').click(function () {
        ...
        $.ajax({
            async:false,
            type: 'post',
            url: "<?php echo e(route('delivery-editdeliverystatus')); ?>",
            headers: {
            ...
            success: function(response) {
                if (response.success == true) {
                    Swal.fire({
                        ...
                        // location.reload();
                        window.location.href = '<?php echo e(url("delivery")); ?>';
                    });
                }
                else{
                    Swal.fire({
    ...
    function GetHeader() {
        $.ajax({
            async:false,
            type: 'post',
            url: "<?php echo e(route('delivery-readheader')); ?>",
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
            },
            data: {
    ...
    function GetDetail(NoTransaksi) {
        $.ajax({
            async:false,
            type: 'post',
            url: "<?php echo e(route('delivery-readdetail')); ?>",
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include the CSRF token in the headers
            },
            data: {
    ...
    function DeleteData(noTransaksi) {
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                async: true,
                type: 'POST',
                url: "<?php echo e(route('delivery-delete')); ?>",
                headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('parts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive\My Project Aplikasi\pos.dstechsmart.com\resources\views/Transaksi/Penjualan/DeliveryNote.blade.php ENDPATH**/ ?>