                ...
                <form action="<?php echo e(route('penggunaaplikasi-rubahlangganan')); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-3">
                                <select required id="ModalJenisUsahaRubahLangganan" name="JenisUsaha" class="form-control text-dark border-0 p-0 h-20px font-size-h5">
                                    <option value="" >Pilih Jenis Usaha</option>
                                    <option value="Retail" >Retail</option>
                                    <option value="FnB" >Food and Beverage</option>
                                    <option value="Hiburan" >Hiburan</option>
                                    <option value="Apotek" >Apotek / Klinik</option>
                                    <option value="Gate" >Tiket & Smart Gate</option>
                                    <option value="Bengkel" >Bengkel dan Dealer</option>
                                </select>
                            </fieldset>
                        </div>
                        <div class="col-md-6">
